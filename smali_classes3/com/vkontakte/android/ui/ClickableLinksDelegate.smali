...
.method public constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-boolean v0, p0, Lcom/vkontakte/android/ui/ClickableLinksDelegate;->canShowMessageOptions:Z
    ...
    .line 41
    iget-boolean v0, p0, Lcom/vkontakte/android/ui/ClickableLinksDelegate;->canShowMessageOptions:Z
    ...
    iput-object v0, p0, Lcom/vkontakte/android/ui/ClickableLinksDelegate;->gestureDetector:Landroid/view/GestureDetector;
...
.method static synthetic lambda$showMessageOptions$0(Ljava/util/ArrayList;Lcom/vkontakte/android/LinkSpan;Landroid/content/Context;Landroid/content/DialogInterface;I)V
    .locals 5
    .param p0, "actions"    # Ljava/util/ArrayList;
    .param p1, "selectedSpan"    # Lcom/vkontakte/android/LinkSpan;
    ...
    .line 202
    :pswitch_0
    invoke-virtual {p1, p2}, Lcom/vkontakte/android/LinkSpan;->onClick(Landroid/content/Context;)V
    ...
    invoke-virtual {p1}, Lcom/vkontakte/android/LinkSpan;->getLink()Ljava/lang/String;
...
.method private showMessageOptions(Landroid/content/Context;Lcom/vkontakte/android/LinkSpan;)V
    .locals 6
    .param p1, "ctx"    # Landroid/content/Context;
    .param p2, "selectedSpan"    # Lcom/vkontakte/android/LinkSpan;
    ...
    :goto_0
    iget-boolean v3, p0, Lcom/vkontakte/android/ui/ClickableLinksDelegate;->canShowMessageOptions:Z
    ...
    :cond_1
    invoke-virtual {p2}, Lcom/vkontakte/android/LinkSpan;->getLink()Ljava/lang/String;
    ...
    invoke-virtual {v3, v4}, Lcom/vkontakte/android/VKAlertDialog$Builder;->setTitle(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;
    ...
    invoke-static {v0, p2, p1}, Lcom/vkontakte/android/ui/ClickableLinksDelegate$$Lambda$1;->lambdaFactory$(Ljava/util/ArrayList;Lcom/vkontakte/android/LinkSpan;Landroid/content/Context;)Landroid/content/DialogInterface$OnClickListener;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lcom/vkontakte/android/ui/ClickableLinksDelegate;->view:Landroid/widget/TextView;
...
.method public onLongPress(Landroid/view/MotionEvent;)V
    ...
    .line 166
    iget-object v0, p0, Lcom/vkontakte/android/ui/ClickableLinksDelegate;->view:Landroid/widget/TextView;

    invoke-virtual {v0}, Landroid/widget/TextView;->getContext()Landroid/content/Context;

    move-result-object v0

    iget-object v1, p0, Lcom/vkontakte/android/ui/ClickableLinksDelegate;->selectedSpan:Lcom/vkontakte/android/LinkSpan;

    invoke-direct {p0, v0, v1}, Lcom/vkontakte/android/ui/ClickableLinksDelegate;->showMessageOptions(Landroid/content/Context;Lcom/vkontakte/android/LinkSpan;)V

    .line 167
    iput-object v2, p0, Lcom/vkontakte/android/ui/ClickableLinksDelegate;->hlPath:Landroid/graphics/Path;

    .line 168
    iput-object v2, p0, Lcom/vkontakte/android/ui/ClickableLinksDelegate;->selectedSpan:Lcom/vkontakte/android/LinkSpan;
...
.method public onTouch(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, v0, Lcom/vkontakte/android/ui/ClickableLinksDelegate;->gestureDetector:Landroid/view/GestureDetector;
    ...
    const-class v20, Lcom/vkontakte/android/LinkSpan;
    ...
    check-cast v15, [Lcom/vkontakte/android/LinkSpan;

    .line 75
    .local v15, "spans":[Lcom/vkontakte/android/LinkSpan;
    array-length v0, v15
    ...
    .line 77
    .local v14, "span":Lcom/vkontakte/android/LinkSpan;
    ...
    iput-object v14, v0, Lcom/vkontakte/android/ui/ClickableLinksDelegate;->selectedSpan:Lcom/vkontakte/android/LinkSpan;

    .line 90
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/vkontakte/android/ui/ClickableLinksDelegate;->hlPaint:Landroid/graphics/Paint;

    move-object/from16 v18, v0

    invoke-virtual {v14}, Lcom/vkontakte/android/LinkSpan;->getColor()I
    ...
    .end local v14    # "span":Lcom/vkontakte/android/LinkSpan;
    .end local v15    # "spans":[Lcom/vkontakte/android/LinkSpan;
    ...
    invoke-virtual/range {v18 .. v19}, Lcom/vkontakte/android/LinkSpan;->onClick(Landroid/content/Context;)V
...
.method public setCanShowMessageOptions(Z)V
    ...
    .prologue
    .line 178
    iput-boolean p1, p0, Lcom/vkontakte/android/ui/ClickableLinksDelegate;->canShowMessageOptions:Z

    .line 179
    iget-object v0, p0, Lcom/vkontakte/android/ui/ClickableLinksDelegate;->gestureDetector:Landroid/view/GestureDetector;
