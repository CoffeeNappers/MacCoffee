...
.method public onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    const-string/jumbo v0, "IpcNotifyService"
    ...
    :cond_0
    iget-object v0, p0, Lru/mail/libverify/ipc/IpcNotificationService;->a:Lru/mail/libverify/ipc/g;

    if-nez v0, :cond_1

    new-instance v0, Lru/mail/libverify/ipc/g;

    invoke-static {p0}, Lru/mail/libverify/api/k;->b(Landroid/content/Context;)Lru/mail/libverify/api/l;

    move-result-object v1

    invoke-direct {v0, v1}, Lru/mail/libverify/ipc/g;-><init>(Lru/mail/libverify/api/l;)V

    iput-object v0, p0, Lru/mail/libverify/ipc/IpcNotificationService;->a:Lru/mail/libverify/ipc/g;

    :cond_1
    iget-object v0, p0, Lru/mail/libverify/ipc/IpcNotificationService;->a:Lru/mail/libverify/ipc/g;

    invoke-virtual {v0}, Lru/mail/libverify/ipc/g;->a()Landroid/os/Messenger;
