...
.method private applyMultipartDataTo(Lio/fabric/sdk/android/services/network/HttpRequest;Lio/fabric/sdk/android/services/settings/AppRequestData;)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    .prologue
    .line 108
    const-string/jumbo v3, "app[identifier]"
    ...
    const-string/jumbo v4, "app[display_version]"
    ...
    const-string/jumbo v4, "app[build_version]"
    ...
    const-string/jumbo v4, "app[source]"
    ...
    const-string/jumbo v4, "app[minimum_sdk_version]"
    ...
    const-string/jumbo v4, "app[built_sdk_version]"
    ...
    .line 117
    const-string/jumbo v3, "app[instance_identifier]"
    ...
    .line 127
    const-string/jumbo v3, "app[icon][hash]"
    ...
    const-string/jumbo v4, "app[icon][data]"
    ...
    const-string/jumbo v4, "app[icon][width]"
    ...
    const-string/jumbo v4, "app[icon][height]"
    ...
    .line 136
    const-string/jumbo v3, "Failed to close app icon InputStream."
