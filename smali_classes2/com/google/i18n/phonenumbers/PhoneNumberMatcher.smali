...
.method private extractInnerMatch(Ljava/lang/String;I)Lcom/google/i18n/phonenumbers/PhoneNumberMatch;
    ...
    .line 350
    .local v7, "possibleInnerMatch":Ljava/util/regex/Pattern;
    invoke-virtual {v7, p1}, Ljava/util/regex/Pattern;->matcher(Ljava/lang/CharSequence;)Ljava/util/regex/Matcher;

    move-result-object v2

    .line 351
    .local v2, "groupMatcher":Ljava/util/regex/Matcher;
    const/4 v4, 0x1

    .line 352
    .local v4, "isFirstMatch":Z
    :goto_1
    ...
    .line 359
    .local v6, "match":Lcom/google/i18n/phonenumbers/PhoneNumberMatch;
    if-eqz v6, :cond_1

    .line 374
    .end local v1    # "group":Ljava/lang/CharSequence;
    .end local v2    # "groupMatcher":Ljava/util/regex/Matcher;
    .end local v4    # "isFirstMatch":Z
    .end local v6    # "match":Lcom/google/i18n/phonenumbers/PhoneNumberMatch;
    .end local v7    # "possibleInnerMatch":Ljava/util/regex/Pattern;
    :cond_0
    :goto_2
    return-object v6

    .line 362
    .restart local v1    # "group":Ljava/lang/CharSequence;
    .restart local v2    # "groupMatcher":Ljava/util/regex/Matcher;
    .restart local v4    # "isFirstMatch":Z
    .restart local v6    # "match":Lcom/google/i18n/phonenumbers/PhoneNumberMatch;
    .restart local v7    # "possibleInnerMatch":Ljava/util/regex/Pattern;
    :cond_1
    iget-wide v8, p0, Lcom/google/i18n/phonenumbers/PhoneNumberMatcher;->maxTries:J
