...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/fragments/GamesFeedFragment$Adapter;
    }
.end annotation
...
# instance fields
.field private adapter:Lcom/vkontakte/android/fragments/GamesFeedFragment$Adapter;
...
.method static synthetic access$000(Lcom/vkontakte/android/fragments/GamesFeedFragment;Ljava/util/List;Z)V
    .locals 0
    ...
    .prologue
    .line 24
    invoke-virtual {p0, p1, p2}, Lcom/vkontakte/android/fragments/GamesFeedFragment;->onDataLoaded(Ljava/util/List;Z)V

    return-void
.end method

.method static synthetic access$100(Lcom/vkontakte/android/fragments/GamesFeedFragment;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Lcom/vkontakte/android/fragments/GamesFeedFragment;
...
.method static synthetic access$200(Lcom/vkontakte/android/fragments/GamesFeedFragment;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Lcom/vkontakte/android/fragments/GamesFeedFragment;
...
.method protected doLoadData(II)V
    ...
    invoke-direct {v0, p0, p0}, Lcom/vkontakte/android/fragments/GamesFeedFragment$1;-><init>(Lcom/vkontakte/android/fragments/GamesFeedFragment;Landroid/app/Fragment;)V

    .line 71
    .local v0, "simpleCallback":Lcom/vkontakte/android/api/SimpleCallback;, "Lcom/vkontakte/android/api/SimpleCallback<Lcom/vkontakte/android/data/VKFromList<Lcom/vkontakte/android/data/GameFeedEntry;>;>;"
    ...
    .line 72
    new-instance v2, Lcom/vkontakte/android/api/apps/AppsGetActivity;
    ...
    invoke-direct {v2, v1, p2, v3}, Lcom/vkontakte/android/api/apps/AppsGetActivity;-><init>(Ljava/lang/String;II)V

    invoke-virtual {v2, v0}, Lcom/vkontakte/android/api/apps/AppsGetActivity;->setCallback(Lcom/vkontakte/android/api/Callback;)Lcom/vkontakte/android/api/VKAPIRequest;
    ...
    iput-object v1, p0, Lcom/vkontakte/android/fragments/GamesFeedFragment;->currentRequest:Lme/grishka/appkit/api/APIRequest;
    ...
    .line 72
    :cond_0
    iget-object v1, p0, Lcom/vkontakte/android/fragments/GamesFeedFragment;->from:Ljava/lang/String;
    ...
    :goto_2
    invoke-direct {v2, v1, p2}, Lcom/vkontakte/android/api/apps/AppsGetActivity;-><init>(Ljava/lang/String;I)V
...
.method protected bridge synthetic getAdapter()Landroid/support/v7/widget/RecyclerView$Adapter;
    ...
    .prologue
    .line 24
    invoke-virtual {p0}, Lcom/vkontakte/android/fragments/GamesFeedFragment;->getAdapter()Lme/grishka/appkit/views/UsableRecyclerView$Adapter;
...
.method protected getAdapter()Lme/grishka/appkit/views/UsableRecyclerView$Adapter;
    ...
    .prologue
    .line 80
    iget-object v0, p0, Lcom/vkontakte/android/fragments/GamesFeedFragment;->adapter:Lcom/vkontakte/android/fragments/GamesFeedFragment$Adapter;

    if-nez v0, :cond_0

    .line 81
    new-instance v0, Lcom/vkontakte/android/fragments/GamesFeedFragment$Adapter;

    invoke-direct {v0, p0}, Lcom/vkontakte/android/fragments/GamesFeedFragment$Adapter;-><init>(Lcom/vkontakte/android/fragments/GamesFeedFragment;)V

    iput-object v0, p0, Lcom/vkontakte/android/fragments/GamesFeedFragment;->adapter:Lcom/vkontakte/android/fragments/GamesFeedFragment$Adapter;
...
.method public onAttach(Landroid/app/Activity;)V
    ...
    invoke-virtual {p0, v0}, Lcom/vkontakte/android/fragments/GamesFeedFragment;->setTitle(I)V
...
.method public onCreateContentView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iget-object v2, p0, Lcom/vkontakte/android/fragments/GamesFeedFragment;->list:Lme/grishka/appkit/views/UsableRecyclerView;
    ...
    invoke-static {p0}, Lcom/vkontakte/android/fragments/GamesFeedFragment$$Lambda$1;->lambdaFactory$(Lcom/vkontakte/android/fragments/GamesFeedFragment;)Lme/grishka/appkit/views/DividerItemDecoration$Provider;
