...
# static fields
.field public static final HORIZONTAL_SPACING:F = 2.0f

.field public static final VERTICAL_SPACING:F = 2.0f
...
.method public static processThumbs(IILjava/util/List;)V
    ...
    .line 25
    .local v53, "thumbs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vkontakte/android/attachments/ThumbAttachment;>;"
    ...
    instance-of v0, v6, Lcom/vkontakte/android/attachments/ThumbAttachment;
    ...
    .line 27
    check-cast v6, Lcom/vkontakte/android/attachments/ThumbAttachment;
    ...
    check-cast v51, Lcom/vkontakte/android/attachments/ThumbAttachment;

    .line 41
    .local v51, "thumb":Lcom/vkontakte/android/attachments/ThumbAttachment;
    invoke-interface/range {v51 .. v51}, Lcom/vkontakte/android/attachments/ThumbAttachment;->getRatio()F
    ...
    .line 47
    invoke-static/range {v41 .. v41}, Lcom/vkontakte/android/ZhukovLayout;->oi(C)I
    ...
    .end local v51    # "thumb":Lcom/vkontakte/android/attachments/ThumbAttachment;
    :cond_7
    if-eqz v8, :cond_8
    ...
    invoke-static/range {v61 .. v62}, Lcom/vkontakte/android/Log;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    check-cast v49, Lcom/vkontakte/android/attachments/ThumbAttachment;

    .line 53
    .local v49, "t":Lcom/vkontakte/android/attachments/ThumbAttachment;
    ...
    invoke-static/range {v63 .. v63}, Lcom/vkontakte/android/Global;->scale(F)I
    ...
    invoke-interface {v0, v1, v2, v3, v4}, Lcom/vkontakte/android/attachments/ThumbAttachment;->setViewSize(FFZZ)V

    goto :goto_4

    .line 58
    .end local v49    # "t":Lcom/vkontakte/android/attachments/ThumbAttachment;
    :cond_8
    ...
    invoke-static/range {v45 .. v45}, Lcom/vkontakte/android/ZhukovLayout;->sum(Ljava/util/List;)F
    ...
    check-cast v61, Lcom/vkontakte/android/attachments/ThumbAttachment;

    const/16 v62, 0x78

    invoke-interface/range {v61 .. v62}, Lcom/vkontakte/android/attachments/ThumbAttachment;->getWidth(C)I
    ...
    invoke-interface/range {v61 .. v65}, Lcom/vkontakte/android/attachments/ThumbAttachment;->setViewSize(FFZZ)V
    ...
    .line 217
    .local v54, "thumbs_remain":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vkontakte/android/attachments/ThumbAttachment;>;"
    ...
    .line 225
    .local v31, "line_thumbs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vkontakte/android/attachments/ThumbAttachment;>;"
    const/16 v24, 0x0
    ...
    .line 233
    .restart local v51    # "thumb":Lcom/vkontakte/android/attachments/ThumbAttachment;
    const/16 v61, 0x0
