...
.method public apply(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    iget v3, v3, Lcom/vkontakte/android/Message;->randomId:I
    ...
    iget-object v2, v2, Lcom/vkontakte/android/Message;->attachments:Ljava/util/List;
    ...
    invoke-virtual {v10, v0}, Lcom/vkontakte/android/attachments/Attachment;->serialize(Ljava/io/DataOutputStream;)V
    ...
    .line 54
    .restart local v10    # "att":Lcom/vkontakte/android/attachments/Attachment;
    instance-of v2, v10, Lcom/vkontakte/android/attachments/GiftAttachment;
    ...
    .line 56
    .local v15, "g":Lcom/vkontakte/android/attachments/GiftAttachment;
    iget v2, v15, Lcom/vkontakte/android/attachments/GiftAttachment;->packID:I
    ...
    invoke-virtual {v2}, Lcom/vkontakte/android/stickers/Stickers;->reload()V

    .line 52
    .end local v15    # "g":Lcom/vkontakte/android/attachments/GiftAttachment;
    :cond_2
    add-int/lit8 v16, v16, 0x1
    ...
    iget-object v4, v0, Lcom/vkontakte/android/cache/AddMessageAction;->m:Lcom/vkontakte/android/Message;
