...
.method public static add(Lcom/vkontakte/android/api/Group;Landroid/content/Context;)V
    ...
    iget-object v5, p0, Lcom/vkontakte/android/api/Group;->activity:Ljava/lang/String;
    ...
    iget v5, p0, Lcom/vkontakte/android/api/Group;->isClosed:I
    ...
    iget-boolean v5, p0, Lcom/vkontakte/android/api/Group;->isAdmin:Z
    ...
    iget v5, p0, Lcom/vkontakte/android/api/Group;->adminLevel:I
    ...
    iget-object v5, p0, Lcom/vkontakte/android/api/Group;->domain:Ljava/lang/String;
    ...
    iget v5, p0, Lcom/vkontakte/android/api/Group;->startTime:I
    ...
    iget-boolean v4, p0, Lcom/vkontakte/android/api/Group;->verified:Z
...
.method public static get()Ljava/util/List;
    ...
    .line 52
    .local v11, "result":Ljava/util/List;, "Ljava/util/List<Lcom/vkontakte/android/api/Group;>;"
    :try_start_0
    ...
    iput-object v1, v9, Lcom/vkontakte/android/api/Group;->activity:Ljava/lang/String;
    ...
    iput-object v1, v9, Lcom/vkontakte/android/api/Group;->domain:Ljava/lang/String;
    ...
    :goto_1
    iput-boolean v1, v9, Lcom/vkontakte/android/api/Group;->verified:Z
    ...
    iput v1, v9, Lcom/vkontakte/android/api/Group;->members_count:I
...
.method public static get(Landroid/content/Context;I)Ljava/util/List;
    ...
    .line 92
    .local v13, "result":Ljava/util/List;, "Ljava/util/List<Lcom/vkontakte/android/api/Group;>;"
    const/4 v12, 0x0
    ...
    iput-object v2, v10, Lcom/vkontakte/android/api/Group;->activity:Ljava/lang/String;
    ...
    iput-object v2, v10, Lcom/vkontakte/android/api/Group;->domain:Ljava/lang/String;
    ...
    :goto_0
    iput-boolean v2, v10, Lcom/vkontakte/android/api/Group;->verified:Z
    ...
    iput v2, v10, Lcom/vkontakte/android/api/Group;->members_count:I
    ...
    .restart local v10    # "group":Lcom/vkontakte/android/api/Group;
...
.method public static replace(Ljava/util/List;)V
    ...
    invoke-direct {v2, v5}, Lcom/vkontakte/android/cache/GroupsCache$CacheOpenHelper;-><init>(Landroid/content/Context;)V
    ...
    iget-object v7, v1, Lcom/vkontakte/android/api/Group;->activity:Ljava/lang/String;
    ...
    iget-boolean v5, v1, Lcom/vkontakte/android/api/Group;->verified:Z
    ...
    iget-object v7, v1, Lcom/vkontakte/android/api/Group;->domain:Ljava/lang/String;
    ...
    iget v7, v1, Lcom/vkontakte/android/api/Group;->members_count:I
