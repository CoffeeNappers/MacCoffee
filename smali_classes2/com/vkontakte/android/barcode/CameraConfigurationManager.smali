.class public Lcom/vkontakte/android/barcode/CameraConfigurationManager;
...
.method public static configure(Landroid/hardware/Camera;)V
    ...
    .line 54
    :cond_2
    invoke-static {v1}, Lcom/vkontakte/android/barcode/CameraConfigurationManager;->configureAdvanced(Landroid/hardware/Camera$Parameters;)V
...
.method private static configureAdvanced(Landroid/hardware/Camera$Parameters;)V
    ...
    .prologue
    .line 63
    invoke-static {p0}, Lcom/vkontakte/android/barcode/CameraConfigurationUtils;->setBestPreviewFPS(Landroid/hardware/Camera$Parameters;)V

    .line 64
    invoke-static {p0}, Lcom/vkontakte/android/barcode/CameraConfigurationUtils;->setBarcodeSceneMode(Landroid/hardware/Camera$Parameters;)V

    .line 65
    invoke-static {p0}, Lcom/vkontakte/android/barcode/CameraConfigurationUtils;->setVideoStabilization(Landroid/hardware/Camera$Parameters;)V

    .line 66
    invoke-static {p0}, Lcom/vkontakte/android/barcode/CameraConfigurationUtils;->setMetering(Landroid/hardware/Camera$Parameters;)V

    .line 67
    const-wide/high16 v0, 0x4000000000000000L    # 2.0

    invoke-static {p0, v0, v1}, Lcom/vkontakte/android/barcode/CameraConfigurationUtils;->setZoom(Landroid/hardware/Camera$Parameters;D)V
...
.method private static logAllParameters(Landroid/hardware/Camera$Parameters;)V
    ...
    .line 72
    invoke-static {p0}, Lcom/vkontakte/android/barcode/CameraConfigurationUtils;->collectStats(Landroid/hardware/Camera$Parameters;)Ljava/lang/String;
