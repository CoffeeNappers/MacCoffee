...
.method static synthetic access$400(Lcom/vkontakte/android/data/database/CitiesAutocompleteAdapter;)Lcom/vkontakte/android/api/VKAPIRequest;
    .locals 1
    .param p0, "x0"    # Lcom/vkontakte/android/data/database/CitiesAutocompleteAdapter;

    .prologue
    .line 24
    iget-object v0, p0, Lcom/vkontakte/android/data/database/CitiesAutocompleteAdapter;->req:Lcom/vkontakte/android/api/VKAPIRequest;

    return-object v0
.end method

.method static synthetic access$402(Lcom/vkontakte/android/data/database/CitiesAutocompleteAdapter;Lcom/vkontakte/android/api/VKAPIRequest;)Lcom/vkontakte/android/api/VKAPIRequest;
    .locals 0
    .param p0, "x0"    # Lcom/vkontakte/android/data/database/CitiesAutocompleteAdapter;
    ...
    .prologue
    .line 24
    iput-object p1, p0, Lcom/vkontakte/android/data/database/CitiesAutocompleteAdapter;->req:Lcom/vkontakte/android/api/VKAPIRequest;
...
.method private loadSearch(Ljava/lang/String;)V
    ...
    .line 149
    :cond_2
    new-instance v0, Lcom/vkontakte/android/api/database/DatabaseGetCities;

    iget v1, p0, Lcom/vkontakte/android/data/database/CitiesAutocompleteAdapter;->country:I

    invoke-direct {v0, v1, p1}, Lcom/vkontakte/android/api/database/DatabaseGetCities;-><init>(ILjava/lang/String;)V
    ...
    .line 150
    invoke-virtual {v0, v1}, Lcom/vkontakte/android/api/database/DatabaseGetCities;->setCallback(Lcom/vkontakte/android/api/Callback;)Lcom/vkontakte/android/api/VKAPIRequest;
    ...
    iput-object v0, p0, Lcom/vkontakte/android/data/database/CitiesAutocompleteAdapter;->req:Lcom/vkontakte/android/api/VKAPIRequest;
