...
.method public static getCountries(ZZLjava/lang/String;)Ljava/util/ArrayList;
    .locals 21
    .param p0, "unique"    # Z
    ...
    .line 22
    .local v10, "result":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vkontakte/android/data/database/Country;>;"
    :try_start_0
    invoke-static {}, Lcom/vkontakte/android/auth/VKAccountManager;->getCurrent()Lcom/vkontakte/android/auth/VKAccount;

    move-result-object v17

    invoke-virtual/range {v17 .. v17}, Lcom/vkontakte/android/auth/VKAccount;->getCountry()I
    ...
    .line 35
    new-instance v9, Lcom/vkontakte/android/data/database/Country;

    invoke-direct {v9}, Lcom/vkontakte/android/data/database/Country;-><init>()V

    .line 36
    .local v9, "none":Lcom/vkontakte/android/data/database/Country;
    const/16 v17, 0x0

    move/from16 v0, v17

    iput v0, v9, Lcom/vkontakte/android/data/database/Country;->id:I
    ...
    iput-object v0, v9, Lcom/vkontakte/android/data/database/Country;->name:Ljava/lang/String;

    .line 38
    invoke-virtual {v10, v9}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 40
    .end local v9    # "none":Lcom/vkontakte/android/data/database/Country;
    :cond_1
    sget-object v17, Lcom/vkontakte/android/VKApplication;->context:Landroid/content/Context;
    ...
    new-instance v2, Lcom/vkontakte/android/data/database/Country;

    invoke-direct {v2}, Lcom/vkontakte/android/data/database/Country;-><init>()V

    .line 49
    .local v2, "c":Lcom/vkontakte/android/data/database/Country;
    const/16 v19, 0x1
    ...
    iput v0, v2, Lcom/vkontakte/android/data/database/Country;->id:I
    ...
    iput-object v0, v2, Lcom/vkontakte/android/data/database/Country;->code:Ljava/lang/String;
    ...
    iput-object v0, v2, Lcom/vkontakte/android/data/database/Country;->name:Ljava/lang/String;
    ...
    iput-object v0, v2, Lcom/vkontakte/android/data/database/Country;->phoneCode:Ljava/lang/String;

    .line 53
    if-eqz p0, :cond_2

    iget-object v0, v2, Lcom/vkontakte/android/data/database/Country;->code:Ljava/lang/String;
    ...
    .line 54
    :cond_2
    iget v0, v2, Lcom/vkontakte/android/data/database/Country;->id:I
    ...
    iput-boolean v0, v2, Lcom/vkontakte/android/data/database/Country;->important:Z
    ...
    .line 30
    .end local v2    # "c":Lcom/vkontakte/android/data/database/Country;
    ...
    .line 37
    .restart local v9    # "none":Lcom/vkontakte/android/data/database/Country;
    ...
    .end local v9    # "none":Lcom/vkontakte/android/data/database/Country;
    .end local p2    # "noneTitle":Ljava/lang/String;
    .restart local v2    # "c":Lcom/vkontakte/android/data/database/Country;
