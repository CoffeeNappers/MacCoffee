.class public Lcom/vkontakte/android/api/video/VideoGet;
...
.method private constructor <init>(IIII)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/vkontakte/android/api/video/VideoGet;->param(Ljava/lang/String;I)Lcom/vkontakte/android/api/VKAPIRequest;
    ...
    invoke-virtual {p0, v0, v2}, Lcom/vkontakte/android/api/video/VideoGet;->param(Ljava/lang/String;I)Lcom/vkontakte/android/api/VKAPIRequest;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/vkontakte/android/api/video/VideoGet;->param(Ljava/lang/String;I)Lcom/vkontakte/android/api/VKAPIRequest;

    .line 45
    return-void
.end method

.method public static get(IIII)Lcom/vkontakte/android/api/video/VideoGet;
    .locals 1
    .param p0, "owner_id"    # I
    .param p1, "album_id"    # I
    .param p2, "offset"    # I
    ...
    .prologue
    .line 29
    new-instance v0, Lcom/vkontakte/android/api/video/VideoGet;

    invoke-direct {v0, p0, p2, p3, p1}, Lcom/vkontakte/android/api/video/VideoGet;-><init>(IIII)V

    return-object v0
.end method

.method public static getAdded(III)Lcom/vkontakte/android/api/video/VideoGet;
    .locals 2
    .param p0, "owner_id"    # I
    .param p1, "offset"    # I
    .param p2, "count"    # I
    ...
    invoke-direct {v0, p0, p1, p2, v1}, Lcom/vkontakte/android/api/video/VideoGet;-><init>(IIII)V

    return-object v0
.end method

.method public static getBookmarks(II)Lcom/vkontakte/android/api/video/VideoGet;
    .locals 3
    .param p0, "offset"    # I
    .param p1, "count"    # I
    ...
    invoke-direct {v0, v1, p0, p1, v2}, Lcom/vkontakte/android/api/video/VideoGet;-><init>(IIII)V

    return-object v0
.end method

.method public static getUploaded(III)Lcom/vkontakte/android/api/video/VideoGet;
    .locals 2
    .param p0, "owner_id"    # I
    .param p1, "offset"    # I
    .param p2, "count"    # I
...
.method public static getUserVideos(III)Lcom/vkontakte/android/api/video/VideoGet;
    .locals 2
    .param p0, "user_id"    # I
    .param p1, "offset"    # I
    .param p2, "count"    # I
...
.method public parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/data/VKList;
    ...
    new-instance v9, Lcom/vkontakte/android/api/video/VideoGet$1;

    invoke-direct {v9, p0, v4}, Lcom/vkontakte/android/api/video/VideoGet$1;-><init>(Lcom/vkontakte/android/api/video/VideoGet;Landroid/util/SparseArray;)V

    invoke-direct {v7, v8, v9}, Lcom/vkontakte/android/data/VKList;-><init>(Lorg/json/JSONObject;Lcom/vkontakte/android/data/Parser;)V
    :try_end_0
...
.method public bridge synthetic parse(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .prologue
    .line 18
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/api/video/VideoGet;->parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/data/VKList;
