.class public Lcom/vkontakte/android/api/video/VideoSearch;
...
.method public constructor <init>(Ljava/lang/String;IIZIZI)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/vkontakte/android/api/video/VideoSearch;->param(Ljava/lang/String;Ljava/lang/String;)Lcom/vkontakte/android/api/VKAPIRequest;

    .line 22
    const-string/jumbo v0, "offset"

    invoke-virtual {p0, v0, p2}, Lcom/vkontakte/android/api/video/VideoSearch;->param(Ljava/lang/String;I)Lcom/vkontakte/android/api/VKAPIRequest;
    ...
    :goto_0
    invoke-virtual {p0, v1, v0}, Lcom/vkontakte/android/api/video/VideoSearch;->param(Ljava/lang/String;Ljava/lang/String;)Lcom/vkontakte/android/api/VKAPIRequest;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/vkontakte/android/api/video/VideoSearch;->param(Ljava/lang/String;Ljava/lang/String;)Lcom/vkontakte/android/api/VKAPIRequest;
...
.method public parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/data/VKList;
    ...
    iget-object v10, v4, Lcom/vkontakte/android/UserProfile;->fullName:Ljava/lang/String;
    ...
    :cond_3
    new-instance v9, Lcom/vkontakte/android/data/VKList;
    ...
    new-instance v11, Lcom/vkontakte/android/api/video/VideoSearch$1;

    invoke-direct {v11, p0, v3, v5}, Lcom/vkontakte/android/api/video/VideoSearch$1;-><init>(Lcom/vkontakte/android/api/video/VideoSearch;Landroid/util/SparseArray;Landroid/util/SparseArray;)V

    invoke-direct {v9, v10, v11}, Lcom/vkontakte/android/data/VKList;-><init>(Lorg/json/JSONObject;Lcom/vkontakte/android/data/Parser;)V
    :try_end_0
...
.method public bridge synthetic parse(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .prologue
    .line 17
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/api/video/VideoSearch;->parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/data/VKList;
