...
.method static synthetic lambda$showErrorToast$0(Landroid/content/Context;Ljava/lang/String;)V
    .locals 0
    .param p0, "context"    # Landroid/content/Context;
    ...
    .prologue
    .line 67
    invoke-static {p0, p1}, Lcom/vkontakte/android/api/APIUtils;->showErrorToastInner(Landroid/content/Context;Ljava/lang/String;)V
...
.method public static showErrorToast(Landroid/content/Context;ILjava/lang/String;)V
    ...
    .line 57
    invoke-static {p1}, Lcom/vkontakte/android/api/VKAPIRequest;->getValueFromErrorCode(I)I
    ...
    :cond_1
    invoke-static {p0, p1, p2}, Lcom/vkontakte/android/api/APIUtils;->getLocalizedError(Landroid/content/Context;ILjava/lang/String;)Ljava/lang/String;
    ...
    .line 65
    invoke-static {p0, v1}, Lcom/vkontakte/android/api/APIUtils;->showErrorToastInner(Landroid/content/Context;Ljava/lang/String;)V

    goto :goto_0

    .line 67
    :cond_2
    invoke-static {p0, v1}, Lcom/vkontakte/android/api/APIUtils$$Lambda$1;->lambdaFactory$(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/Runnable;

    move-result-object v2

    invoke-static {v2}, Lcom/vkontakte/android/ViewUtils;->post(Ljava/lang/Runnable;)V
