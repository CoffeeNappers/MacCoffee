.class public Lcom/vkontakte/android/api/PersistentCookieStore;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 22
    const-class v0, Lcom/vkontakte/android/api/PersistentCookieStore;
    ...
    sput-object v0, Lcom/vkontakte/android/api/PersistentCookieStore;->TAG:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/vkontakte/android/api/PersistentCookieStore;->sharedPreferences:Landroid/content/SharedPreferences;

    .line 38
    invoke-direct {p0}, Lcom/vkontakte/android/api/PersistentCookieStore;->loadAllFromPersistence()V
...
.method private static cookieUri(Ljava/net/URI;Ljava/net/HttpCookie;)Ljava/net/URI;
    ...
    sget-object v4, Lcom/vkontakte/android/api/PersistentCookieStore;->TAG:Ljava/lang/String;
...
.method private getValidCookies(Ljava/net/URI;)Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/vkontakte/android/api/PersistentCookieStore;->allCookies:Ljava/util/Map;
    ...
    invoke-direct {p0, v6, v7}, Lcom/vkontakte/android/api/PersistentCookieStore;->domainMatch(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 185
    invoke-direct {p0, p1, v0}, Lcom/vkontakte/android/api/PersistentCookieStore;->removeFromPersistence(Ljava/net/URI;Ljava/util/List;)V
...
.method private loadAllFromPersistence()V
    ...
    iput-object v8, p0, Lcom/vkontakte/android/api/PersistentCookieStore;->allCookies:Ljava/util/Map;

    .line 44
    iget-object v8, p0, Lcom/vkontakte/android/api/PersistentCookieStore;->sharedPreferences:Landroid/content/SharedPreferences;
    ...
    new-instance v8, Lcom/vkontakte/android/api/SerializableHttpCookie;

    invoke-direct {v8}, Lcom/vkontakte/android/api/SerializableHttpCookie;-><init>()V

    .line 52
    invoke-virtual {v8, v3}, Lcom/vkontakte/android/api/SerializableHttpCookie;->decode(Ljava/lang/String;)Ljava/net/HttpCookie;

    move-result-object v1

    .line 54
    .local v1, "cookie":Ljava/net/HttpCookie;
    iget-object v8, p0, Lcom/vkontakte/android/api/PersistentCookieStore;->allCookies:Ljava/util/Map;
    ...
    sget-object v8, Lcom/vkontakte/android/api/PersistentCookieStore;->TAG:Ljava/lang/String;
...
.method private removeAllFromPersistence()V
    ...
    .prologue
    .line 232
    iget-object v0, p0, Lcom/vkontakte/android/api/PersistentCookieStore;->sharedPreferences:Landroid/content/SharedPreferences;
...
.method private removeFromPersistence(Ljava/net/URI;Ljava/net/HttpCookie;)V
    ...
    .prologue
    .line 218
    iget-object v1, p0, Lcom/vkontakte/android/api/PersistentCookieStore;->sharedPreferences:Landroid/content/SharedPreferences;
...
.method private removeFromPersistence(Ljava/net/URI;Ljava/util/List;)V
    ...
    iget-object v2, p0, Lcom/vkontakte/android/api/PersistentCookieStore;->sharedPreferences:Landroid/content/SharedPreferences;
...
.method private saveToPersistence(Ljava/net/URI;Ljava/net/HttpCookie;)V
    ...
    new-instance v2, Lcom/vkontakte/android/api/SerializableHttpCookie;

    invoke-direct {v2}, Lcom/vkontakte/android/api/SerializableHttpCookie;-><init>()V

    .line 114
    invoke-virtual {v2, p2}, Lcom/vkontakte/android/api/SerializableHttpCookie;->encode(Ljava/net/HttpCookie;)Ljava/lang/String;
...
.method public declared-synchronized add(Ljava/net/URI;Ljava/net/HttpCookie;)V
    ...
    :try_start_0
    invoke-static {p1, p2}, Lcom/vkontakte/android/api/PersistentCookieStore;->cookieUri(Ljava/net/URI;Ljava/net/HttpCookie;)Ljava/net/URI;

    move-result-object p1

    .line 73
    iget-object v1, p0, Lcom/vkontakte/android/api/PersistentCookieStore;->allCookies:Ljava/util/Map;
    ...
    .line 81
    invoke-direct {p0, p1, p2}, Lcom/vkontakte/android/api/PersistentCookieStore;->saveToPersistence(Ljava/net/URI;Ljava/net/HttpCookie;)V
    :try_end_0
...
.method public declared-synchronized get(Ljava/net/URI;)Ljava/util/List;
    ...
    :try_start_0
    invoke-direct {p0, p1}, Lcom/vkontakte/android/api/PersistentCookieStore;->getValidCookies(Ljava/net/URI;)Ljava/util/List;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized getCookies()Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/vkontakte/android/api/PersistentCookieStore;->allCookies:Ljava/util/Map;
    ...
    invoke-direct {p0, v2}, Lcom/vkontakte/android/api/PersistentCookieStore;->getValidCookies(Ljava/net/URI;)Ljava/util/List;
...
.method public declared-synchronized remove(Ljava/net/URI;Ljava/net/HttpCookie;)Z
    ...
    .line 211
    invoke-direct {p0, p1, p2}, Lcom/vkontakte/android/api/PersistentCookieStore;->removeFromPersistence(Ljava/net/URI;Ljava/net/HttpCookie;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized removeAll()Z
    ...
    :try_start_0
    iget-object v0, p0, Lcom/vkontakte/android/api/PersistentCookieStore;->allCookies:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->clear()V

    .line 227
    invoke-direct {p0}, Lcom/vkontakte/android/api/PersistentCookieStore;->removeAllFromPersistence()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
