.class public Lcom/vkontakte/android/api/groups/GroupsGetAdminMembers;
...
.method public constructor <init>(IIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, p5}, Lcom/vkontakte/android/api/groups/GroupsGetAdminMembers;->param(Ljava/lang/String;Ljava/lang/String;)Lcom/vkontakte/android/api/VKAPIRequest;

    .line 22
    const-string/jumbo v0, "group_id"

    invoke-virtual {p0, v0, p1}, Lcom/vkontakte/android/api/groups/GroupsGetAdminMembers;->param(Ljava/lang/String;I)Lcom/vkontakte/android/api/VKAPIRequest;
    ...
    invoke-virtual {p0, v0, p4}, Lcom/vkontakte/android/api/groups/GroupsGetAdminMembers;->param(Ljava/lang/String;Ljava/lang/String;)Lcom/vkontakte/android/api/VKAPIRequest;
    ...
    invoke-virtual {p0, v0, p6}, Lcom/vkontakte/android/api/groups/GroupsGetAdminMembers;->param(Ljava/lang/String;Ljava/lang/String;)Lcom/vkontakte/android/api/VKAPIRequest;
    ...
    invoke-virtual {p0, v0, p7}, Lcom/vkontakte/android/api/groups/GroupsGetAdminMembers;->param(Ljava/lang/String;Ljava/lang/String;)Lcom/vkontakte/android/api/VKAPIRequest;
...
.method public parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/data/VKList;
    ...
    const-class v11, Lcom/vkontakte/android/UserProfile;

    invoke-direct {v6, v10, v11}, Lcom/vkontakte/android/data/VKList;-><init>(Lorg/json/JSONObject;Ljava/lang/Class;)V

    .line 55
    .local v6, "res":Lcom/vkontakte/android/data/VKList;, "Lcom/vkontakte/android/data/VKList<Lcom/vkontakte/android/UserProfile;>;"
    ...
    invoke-static {v7, v10}, Lcom/vkontakte/android/utils/Utils;->containsKey(Landroid/util/SparseArray;I)Z
    ...
    .line 57
    iget-object v12, v5, Lcom/vkontakte/android/UserProfile;->extra:Landroid/os/Bundle;
    ...
    invoke-static {v8, v10}, Lcom/vkontakte/android/utils/Utils;->containsKey(Landroid/util/SparseArray;I)Z
    ...
    .end local v6    # "res":Lcom/vkontakte/android/data/VKList;, "Lcom/vkontakte/android/data/VKList<Lcom/vkontakte/android/UserProfile;>;"
...
.method public bridge synthetic parse(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .prologue
    .line 17
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/api/groups/GroupsGetAdminMembers;->parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/data/VKList;
