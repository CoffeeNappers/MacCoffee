.class public Lcom/vkontakte/android/api/messages/MessagesGetChat;
...
.method public constructor <init>(I)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/vkontakte/android/api/messages/MessagesGetChat;->param(Ljava/lang/String;I)Lcom/vkontakte/android/api/VKAPIRequest;

    move-result-object v0

    const-string/jumbo v1, "fields"

    const-string/jumbo v2, "photo_50,photo_100,sex,domain"
...
# virtual methods
.method public parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/api/messages/MessagesGetChat$Result;
    .locals 22
    ...
    .line 31
    .local v12, "profiles":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vkontakte/android/ChatUser;>;"
    new-instance v17, Landroid/util/SparseArray;

    invoke-direct/range {v17 .. v17}, Landroid/util/SparseArray;-><init>()V

    .line 32
    .local v17, "users":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/vkontakte/android/UserProfile;>;"
    ...
    invoke-direct {v11, v7}, Lcom/vkontakte/android/UserProfile;-><init>(Lorg/json/JSONObject;)V
    ...
    invoke-static {v0, v6}, Lcom/vkontakte/android/utils/Utils;->containsKey(Landroid/util/SparseArray;I)Z
    ...
    .line 47
    invoke-static {v9}, Lcom/vkontakte/android/data/Friends;->getUsersBlocking(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    .end local v12    # "profiles":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vkontakte/android/ChatUser;>;"
    .end local v13    # "r":Lorg/json/JSONObject;
    .end local v15    # "u":Lcom/vkontakte/android/UserProfile;
    .end local v17    # "users":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/vkontakte/android/UserProfile;>;"
    ...
    .restart local v12    # "profiles":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vkontakte/android/ChatUser;>;"
    .restart local v13    # "r":Lorg/json/JSONObject;
    .restart local v17    # "users":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/vkontakte/android/UserProfile;>;"
    :cond_3
    const/4 v5, 0x0
    ...
    :cond_6
    :goto_5
    new-instance v14, Lcom/vkontakte/android/api/messages/MessagesGetChat$Result;

    invoke-direct {v14}, Lcom/vkontakte/android/api/messages/MessagesGetChat$Result;-><init>()V

    .line 73
    .local v14, "result":Lcom/vkontakte/android/api/messages/MessagesGetChat$Result;
    iput-object v12, v14, Lcom/vkontakte/android/api/messages/MessagesGetChat$Result;->users:Ljava/util/ArrayList;
    ...
    iput-object v0, v14, Lcom/vkontakte/android/api/messages/MessagesGetChat$Result;->title:Ljava/lang/String;
    ...
    :goto_6
    invoke-static {v12}, Lcom/vkontakte/android/data/Messages;->createChatPhoto(Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    iput-object v0, v14, Lcom/vkontakte/android/api/messages/MessagesGetChat$Result;->photo:Ljava/lang/String;
    ...
    iput v0, v14, Lcom/vkontakte/android/api/messages/MessagesGetChat$Result;->adminID:I

    .line 77
    iput v4, v14, Lcom/vkontakte/android/api/messages/MessagesGetChat$Result;->dnd:I

    .line 78
    iput-boolean v10, v14, Lcom/vkontakte/android/api/messages/MessagesGetChat$Result;->mute:Z

    goto/16 :goto_3

    .line 69
    .end local v14    # "result":Lcom/vkontakte/android/api/messages/MessagesGetChat$Result;
    ...
    .line 75
    .end local v8    # "jps":Lorg/json/JSONObject;
    .restart local v14    # "result":Lcom/vkontakte/android/api/messages/MessagesGetChat$Result;
    :cond_8
...
.method public bridge synthetic parse(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .prologue
    .line 19
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/api/messages/MessagesGetChat;->parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/api/messages/MessagesGetChat$Result;
