.class Lcom/vkontakte/android/api/messages/MessagesSearch$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/vkontakte/android/api/messages/MessagesSearch;->parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/api/messages/MessagesSearch$Result;
.end annotation
...
# instance fields
.field final synthetic this$0:Lcom/vkontakte/android/api/messages/MessagesSearch;

.field final synthetic val$chats:Ljava/util/ArrayList;


# direct methods
.method constructor <init>(Lcom/vkontakte/android/api/messages/MessagesSearch;Ljava/util/ArrayList;)V
    .locals 0
    .param p1, "this$0"    # Lcom/vkontakte/android/api/messages/MessagesSearch;

    .prologue
    .line 31
    iput-object p1, p0, Lcom/vkontakte/android/api/messages/MessagesSearch$1;->this$0:Lcom/vkontakte/android/api/messages/MessagesSearch;

    iput-object p2, p0, Lcom/vkontakte/android/api/messages/MessagesSearch$1;->val$chats:Ljava/util/ArrayList;
...
.method public parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/Message;
    ...
    invoke-direct {v2, p1}, Lcom/vkontakte/android/Message;-><init>(Lorg/json/JSONObject;)V

    .line 35
    .local v2, "msg":Lcom/vkontakte/android/Message;
    iget v5, v2, Lcom/vkontakte/android/Message;->peer:I
    ...
    .line 38
    iget-object v5, v2, Lcom/vkontakte/android/Message;->title:Ljava/lang/String;
    ...
    .line 50
    :goto_1
    iget-object v5, p0, Lcom/vkontakte/android/api/messages/MessagesSearch$1;->val$chats:Ljava/util/ArrayList;
...
.method public bridge synthetic parse(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .prologue
    .line 31
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/api/messages/MessagesSearch$1;->parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/Message;
