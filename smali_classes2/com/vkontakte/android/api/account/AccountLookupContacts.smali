.class public Lcom/vkontakte/android/api/account/AccountLookupContacts;
...
.method public parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/api/account/AccountLookupContacts$Result;
    ...
    .local v1, "found":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vkontakte/android/UserProfile;>;"
    ...
    iput-object v10, v7, Lcom/vkontakte/android/UserProfile;->extra:Landroid/os/Bundle;
    ...
    .line 46
    .restart local v7    # "profile":Lcom/vkontakte/android/UserProfile;
    ...
    .end local v7    # "profile":Lcom/vkontakte/android/UserProfile;
    :cond_2
    new-instance v8, Lcom/vkontakte/android/api/account/AccountLookupContacts$Result;

    invoke-direct {v8}, Lcom/vkontakte/android/api/account/AccountLookupContacts$Result;-><init>()V

    .line 53
    .local v8, "res":Lcom/vkontakte/android/api/account/AccountLookupContacts$Result;
    iput-object v1, v8, Lcom/vkontakte/android/api/account/AccountLookupContacts$Result;->found:Ljava/util/ArrayList;

    .line 54
    iput-object v6, v8, Lcom/vkontakte/android/api/account/AccountLookupContacts$Result;->other:Ljava/util/ArrayList;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 59
    .end local v1    # "found":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vkontakte/android/UserProfile;>;"
    .end local v2    # "i":I
    .end local v3    # "jfound":Lorg/json/JSONArray;
    .end local v4    # "jother":Lorg/json/JSONArray;
    .end local v6    # "other":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vkontakte/android/UserProfile;>;"
    .end local v8    # "res":Lcom/vkontakte/android/api/account/AccountLookupContacts$Result;
    :goto_3
    return-object v8
...
.method public bridge synthetic parse(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .prologue
    .line 18
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/api/account/AccountLookupContacts;->parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/api/account/AccountLookupContacts$Result;
