.class public Lcom/vkontakte/android/api/SerializableHttpCookie;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 18
    const-class v0, Lcom/vkontakte/android/api/SerializableHttpCookie;
    ...
    sput-object v0, Lcom/vkontakte/android/api/SerializableHttpCookie;->TAG:Ljava/lang/String;
...
.method private getHttpOnly()Z
    ...
    .line 69
    :try_start_0
    invoke-direct {p0}, Lcom/vkontakte/android/api/SerializableHttpCookie;->initFieldHttpOnly()V

    .line 70
    iget-object v1, p0, Lcom/vkontakte/android/api/SerializableHttpCookie;->fieldHttpOnly:Ljava/lang/reflect/Field;

    iget-object v2, p0, Lcom/vkontakte/android/api/SerializableHttpCookie;->cookie:Ljava/net/HttpCookie;
    ...
    sget-object v1, Lcom/vkontakte/android/api/SerializableHttpCookie;->TAG:Ljava/lang/String;
...
.method private initFieldHttpOnly()V
    ...
    .prologue
    .line 92
    iget-object v0, p0, Lcom/vkontakte/android/api/SerializableHttpCookie;->cookie:Ljava/net/HttpCookie;
    ...
    iput-object v0, p0, Lcom/vkontakte/android/api/SerializableHttpCookie;->fieldHttpOnly:Ljava/lang/reflect/Field;

    .line 93
    iget-object v0, p0, Lcom/vkontakte/android/api/SerializableHttpCookie;->fieldHttpOnly:Ljava/lang/reflect/Field;
...
.method private readObject(Ljava/io/ObjectInputStream;)V
    ...
    iput-object v2, p0, Lcom/vkontakte/android/api/SerializableHttpCookie;->cookie:Ljava/net/HttpCookie;

    .line 116
    iget-object v3, p0, Lcom/vkontakte/android/api/SerializableHttpCookie;->cookie:Ljava/net/HttpCookie;
    ...
    invoke-direct {p0, v2}, Lcom/vkontakte/android/api/SerializableHttpCookie;->setHttpOnly(Z)V
...
.method private writeObject(Ljava/io/ObjectOutputStream;)V
    ...
    .line 108
    invoke-direct {p0}, Lcom/vkontakte/android/api/SerializableHttpCookie;->getHttpOnly()Z
...
.method public decode(Ljava/lang/String;)Ljava/net/HttpCookie;
    ...
    .prologue
    .line 49
    invoke-direct {p0, p1}, Lcom/vkontakte/android/api/SerializableHttpCookie;->hexStringToByteArray(Ljava/lang/String;)[B
    ...
    check-cast v5, Lcom/vkontakte/android/api/SerializableHttpCookie;

    iget-object v2, v5, Lcom/vkontakte/android/api/SerializableHttpCookie;->cookie:Ljava/net/HttpCookie;
    :try_end_0
    ...
    sget-object v5, Lcom/vkontakte/android/api/SerializableHttpCookie;->TAG:Ljava/lang/String;
...
.method public encode(Ljava/net/HttpCookie;)Ljava/lang/String;
    ...
    .prologue
    .line 34
    iput-object p1, p0, Lcom/vkontakte/android/api/SerializableHttpCookie;->cookie:Ljava/net/HttpCookie;
    ...
    invoke-direct {p0, v3}, Lcom/vkontakte/android/api/SerializableHttpCookie;->byteArrayToHexString([B)Ljava/lang/String;
    ...
    sget-object v3, Lcom/vkontakte/android/api/SerializableHttpCookie;->TAG:Ljava/lang/String;
