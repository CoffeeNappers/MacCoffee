.class public Lcom/vkontakte/android/api/photos/PhotosGetNewTags;
...
.method public constructor <init>(II)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/vkontakte/android/api/photos/PhotosGetNewTags;->param(Ljava/lang/String;I)Lcom/vkontakte/android/api/VKAPIRequest;
...
# virtual methods
.method public parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/api/photos/PhotosGetNewTags$Result;
    .locals 9
    ...
    .prologue
    .line 27
    new-instance v4, Lcom/vkontakte/android/api/photos/PhotosGetNewTags$Result;

    invoke-direct {v4}, Lcom/vkontakte/android/api/photos/PhotosGetNewTags$Result;-><init>()V

    .line 28
    .local v4, "result":Lcom/vkontakte/android/api/photos/PhotosGetNewTags$Result;
    ...
    invoke-direct {v5, v7, v8}, Lcom/vkontakte/android/data/VKList;-><init>(Lorg/json/JSONObject;Ljava/lang/Class;)V

    .line 29
    .local v5, "tmp":Lcom/vkontakte/android/data/VKList;
    check-cast v5, Lcom/vkontakte/android/data/VKList;

    .end local v5    # "tmp":Lcom/vkontakte/android/data/VKList;
    iput-object v5, v4, Lcom/vkontakte/android/api/photos/PhotosGetNewTags$Result;->photos:Lcom/vkontakte/android/data/VKList;
    ...
    iput-object v7, v4, Lcom/vkontakte/android/api/photos/PhotosGetNewTags$Result;->profiles:Landroid/util/SparseArray;
    ...
    iget-object v7, v4, Lcom/vkontakte/android/api/photos/PhotosGetNewTags$Result;->profiles:Landroid/util/SparseArray;
...
.method public bridge synthetic parse(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .prologue
    .line 18
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/api/photos/PhotosGetNewTags;->parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/api/photos/PhotosGetNewTags$Result;
