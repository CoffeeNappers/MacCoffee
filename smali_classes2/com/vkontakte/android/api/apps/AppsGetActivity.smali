.class public Lcom/vkontakte/android/api/apps/AppsGetActivity;
...
.method public constructor <init>(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/vkontakte/android/api/apps/AppsGetActivity;->param(Ljava/lang/String;Ljava/lang/String;)Lcom/vkontakte/android/api/VKAPIRequest;
    ...
    invoke-virtual {p0, v0, p1}, Lcom/vkontakte/android/api/apps/AppsGetActivity;->param(Ljava/lang/String;Ljava/lang/String;)Lcom/vkontakte/android/api/VKAPIRequest;

    .line 29
    const-string/jumbo v0, "count"

    invoke-virtual {p0, v0, p2}, Lcom/vkontakte/android/api/apps/AppsGetActivity;->param(Ljava/lang/String;I)Lcom/vkontakte/android/api/VKAPIRequest;
...
.method public constructor <init>(Ljava/lang/String;II)V
    ...
    .prologue
    .line 20
    invoke-direct {p0, p1, p2}, Lcom/vkontakte/android/api/apps/AppsGetActivity;-><init>(Ljava/lang/String;I)V

    .line 21
    const-string/jumbo v0, "filter_app_id"

    invoke-virtual {p0, v0, p3}, Lcom/vkontakte/android/api/apps/AppsGetActivity;->param(Ljava/lang/String;I)Lcom/vkontakte/android/api/VKAPIRequest;
...
# virtual methods
.method public parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/data/VKFromList;
    .locals 14
    ...
    .line 35
    .local v9, "profiles":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/vkontakte/android/UserProfile;>;"
    new-instance v1, Landroid/util/SparseArray;

    invoke-direct {v1}, Landroid/util/SparseArray;-><init>()V

    .line 36
    .local v1, "apps":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/vkontakte/android/data/ApiApplication;>;"
    new-instance v4, Lcom/vkontakte/android/data/VKFromList;
    ...
    invoke-direct {v4, v12}, Lcom/vkontakte/android/data/VKFromList;-><init>(Ljava/lang/String;)V

    .line 37
    .local v4, "feed":Lcom/vkontakte/android/data/VKFromList;, "Lcom/vkontakte/android/data/VKFromList<Lcom/vkontakte/android/data/GameFeedEntry;>;"
    const-string/jumbo v12, "response"
    ...
    :goto_2
    iput-boolean v12, v8, Lcom/vkontakte/android/UserProfile;->f:Z
    ...
    invoke-direct {v0, v12}, Lcom/vkontakte/android/data/ApiApplication;-><init>(Lorg/json/JSONObject;)V

    .line 52
    .local v0, "app":Lcom/vkontakte/android/data/ApiApplication;
    iget v12, v0, Lcom/vkontakte/android/data/ApiApplication;->id:I
    ...
    iget-object v6, v12, Lcom/vkontakte/android/api/JSONArrayWithCount;->array:Lorg/json/JSONArray;
    ...
    .line 57
    new-instance v3, Lcom/vkontakte/android/data/GameFeedEntry;

    invoke-virtual {v6, v5}, Lorg/json/JSONArray;->getJSONObject(I)Lorg/json/JSONObject;

    move-result-object v12

    invoke-direct {v3, v12, v9, v1}, Lcom/vkontakte/android/data/GameFeedEntry;-><init>(Lorg/json/JSONObject;Landroid/util/SparseArray;Landroid/util/SparseArray;)V
    ...
    .line 59
    invoke-virtual {v4, v3}, Lcom/vkontakte/android/data/VKFromList;->add(Ljava/lang/Object;)Z
    ...
    .line 66
    .end local v1    # "apps":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/vkontakte/android/data/ApiApplication;>;"
    .end local v2    # "apps1":Lorg/json/JSONArray;
    .end local v3    # "e":Lcom/vkontakte/android/data/GameFeedEntry;
    .end local v4    # "feed":Lcom/vkontakte/android/data/VKFromList;, "Lcom/vkontakte/android/data/VKFromList<Lcom/vkontakte/android/data/GameFeedEntry;>;"
    .end local v5    # "i":I
    .end local v6    # "jfeed":Lorg/json/JSONArray;
    .end local v9    # "profiles":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/vkontakte/android/UserProfile;>;"
...
.method public bridge synthetic parse(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .prologue
    .line 17
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/api/apps/AppsGetActivity;->parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/data/VKFromList;
