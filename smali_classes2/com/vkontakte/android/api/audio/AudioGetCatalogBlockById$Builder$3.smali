.class Lcom/vkontakte/android/api/audio/AudioGetCatalogBlockById$Builder$3;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/vkontakte/android/api/audio/AudioGetCatalogBlockById$Builder;->buildProfiles()Lcom/vkontakte/android/api/VKAPIRequest;
.end annotation
...
.method constructor <init>(Lcom/vkontakte/android/api/audio/AudioGetCatalogBlockById$Builder;Ljava/lang/String;)V
    ...
    .prologue
    .line 78
    iput-object p1, p0, Lcom/vkontakte/android/api/audio/AudioGetCatalogBlockById$Builder$3;->this$0:Lcom/vkontakte/android/api/audio/AudioGetCatalogBlockById$Builder;
...
.method public parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/data/VKList;
    ...
    .line 82
    :try_start_0
    iget-object v3, p0, Lcom/vkontakte/android/api/audio/AudioGetCatalogBlockById$Builder$3;->this$0:Lcom/vkontakte/android/api/audio/AudioGetCatalogBlockById$Builder;
    ...
    .line 84
    .local v2, "vkList":Lcom/vkontakte/android/data/VKList;, "Lcom/vkontakte/android/data/VKList<Lcom/vkontakte/android/UserProfile;>;"
    iget v3, v1, Lcom/vk/music/dto/Section;->count:I

    invoke-virtual {v2, v3}, Lcom/vkontakte/android/data/VKList;->setTotal(I)V

    .line 85
    iget-object v3, v1, Lcom/vk/music/dto/Section;->profiles:Ljava/util/ArrayList;
    ...
    .end local v2    # "vkList":Lcom/vkontakte/android/data/VKList;, "Lcom/vkontakte/android/data/VKList<Lcom/vkontakte/android/UserProfile;>;"
    :cond_0
    :goto_0
    return-object v2
...
.method public bridge synthetic parse(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .prologue
    .line 78
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/api/audio/AudioGetCatalogBlockById$Builder$3;->parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/data/VKList;
