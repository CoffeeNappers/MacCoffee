.class public Lcom/vkontakte/android/api/newsfeed/NewsfeedGetComments;
...
.method public constructor <init>(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/vkontakte/android/api/newsfeed/NewsfeedGetComments;->param(Ljava/lang/String;Ljava/lang/String;)Lcom/vkontakte/android/api/VKAPIRequest;

    .line 24
    :cond_0
    const-string/jumbo v0, "count"

    invoke-virtual {p0, v0, p2}, Lcom/vkontakte/android/api/newsfeed/NewsfeedGetComments;->param(Ljava/lang/String;I)Lcom/vkontakte/android/api/VKAPIRequest;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/vkontakte/android/api/newsfeed/NewsfeedGetComments;->param(Ljava/lang/String;I)Lcom/vkontakte/android/api/VKAPIRequest;
...
.method public parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/data/VKFromList;
    ...
    new-instance v10, Lcom/vkontakte/android/data/VKFromList;
    ...
    invoke-direct {v10, v13}, Lcom/vkontakte/android/data/VKFromList;-><init>(Ljava/lang/String;)V

    .line 36
    .local v10, "result":Lcom/vkontakte/android/data/VKFromList;, "Lcom/vkontakte/android/data/VKFromList<Lcom/vkontakte/android/NewsEntry;>;"
    if-nez v6, :cond_1
    ...
    .end local v10    # "result":Lcom/vkontakte/android/data/VKFromList;, "Lcom/vkontakte/android/data/VKFromList<Lcom/vkontakte/android/NewsEntry;>;"
    :cond_0
    :goto_0
    return-object v10
    ...
    .restart local v10    # "result":Lcom/vkontakte/android/data/VKFromList;, "Lcom/vkontakte/android/data/VKFromList<Lcom/vkontakte/android/NewsEntry;>;"
    :cond_1
    ...
    invoke-direct {v2, v13, v14, v7, v8}, Lcom/vkontakte/android/NewsEntry;-><init>(Lorg/json/JSONObject;Ljava/lang/String;Landroid/util/SparseArray;Landroid/util/SparseArray;)V

    .line 64
    .local v2, "e":Lcom/vkontakte/android/NewsEntry;
    iget v13, v2, Lcom/vkontakte/android/NewsEntry;->ownerID:I
    ...
    .line 65
    iget v13, v2, Lcom/vkontakte/android/NewsEntry;->flags:I

    or-int/lit8 v13, v13, 0x40

    iput v13, v2, Lcom/vkontakte/android/NewsEntry;->flags:I

    .line 67
    :cond_7
    invoke-virtual {v10, v2}, Lcom/vkontakte/android/data/VKFromList;->add(Ljava/lang/Object;)Z
    :try_end_0
...
.method public bridge synthetic parse(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .prologue
    .line 16
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/api/newsfeed/NewsfeedGetComments;->parse(Lorg/json/JSONObject;)Lcom/vkontakte/android/data/VKFromList;
