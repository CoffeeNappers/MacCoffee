...
.method public call()Lcom/facebook/imagepipeline/image/EncodedImage;
    ...
    const-string/jumbo v6, "Found image for %s in staging area"
    ...
    const-string/jumbo v6, "Host thread was interrupted, decreasing reference count"
    ...
    const-string/jumbo v6, "Did not find image for %s in staging area"
