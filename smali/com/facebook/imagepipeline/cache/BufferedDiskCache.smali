...
.method private checkInStagingAreaAndFileCache(Lcom/facebook/cache/common/CacheKey;)Z
    ...
    const-string/jumbo v3, "Found image for %s in staging area"
    ...
    const-string/jumbo v3, "Did not find image for %s in staging area"
...
.method private readFromDiskCache(Lcom/facebook/cache/common/CacheKey;)Lcom/facebook/imagepipeline/memory/PooledByteBuffer;
    ...
    const-string/jumbo v5, "Disk cache read for %s"
    ...
    const-string/jumbo v5, "Disk cache miss for %s"
    ...
    const-string/jumbo v5, "Found entry in disk cache for %s"
    ...
    const-string/jumbo v5, "Successful read from disk cache for %s"
    ...
    const-string/jumbo v5, "Exception reading from cache for %s"
...
.method private writeToDiskCache(Lcom/facebook/cache/common/CacheKey;Lcom/facebook/imagepipeline/image/EncodedImage;)V
    ...
    const-string/jumbo v2, "About to write to disk-cache for key %s"
    ...
    const-string/jumbo v2, "Successful disk-cache write for key %s"
