...
.method private deleteUnmentionedFiles([Lcom/facebook/soloader/UnpackingSoSource$Dso;)V
    ...
    const-string/jumbo v8, "unable to list directory "
    ...
    const-string/jumbo v6, "dso_state"
    ...
    const-string/jumbo v6, "dso_lock"
    ...
    const-string/jumbo v6, "dso_manifest"
    ...
    const-string/jumbo v6, "fb-UnpackingSoSource"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "deleting unaccounted-for file "
...
.method private extractDso(Lcom/facebook/soloader/UnpackingSoSource$InputDso;[B)V
    ...
    .line 175
    const-string/jumbo v5, "fb-UnpackingSoSource"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v7, "extracting DSO "
    ...
    const-string/jumbo v7, "cannot make file executable: "
    ...
    const-string/jumbo v7, "error overwriting "
    ...
    const-string/jumbo v7, " trying to delete and start over"
...
.method private refreshLocked(Lcom/facebook/soloader/FileLocker;I[B)Z
    ...
    const-string/jumbo v5, "dso_state"
    ...
    const-string/jumbo v18, "dso store "
    ...
    const-string/jumbo v18, " regeneration interrupted: wiping clean"
    ...
    const-string/jumbo v5, "dso_deps"
    ...
    const-string/jumbo v5, "deps mismatch on deps store: regenerating"
    ...
    const-string/jumbo v5, "so store dirty: regenerating"
...
.method private regenerate(BLcom/facebook/soloader/UnpackingSoSource$DsoManifest;Lcom/facebook/soloader/UnpackingSoSource$InputDsoIterator;)V
    ...
    .prologue
    .line 206
    const-string/jumbo v11, "fb-UnpackingSoSource"

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v13, "regenerating DSO store "
    ...
    const-string/jumbo v12, "dso_manifest"
    ...
    const-string/jumbo v12, "error reading existing DSO manifest"
...
.method protected prepare(I)V
    ...
    const-string/jumbo v3, "dso_lock"
    ...
    const-string/jumbo v4, "locked dso store "
    ...
    const-string/jumbo v4, "dso store is up-to-date: "
    ...
    const-string/jumbo v4, "not releasing dso store lock for "
    ...
    const-string/jumbo v4, " (syncer thread started)"
    ...
    const-string/jumbo v5, "not releasing dso store lock for "
    ...
    const-string/jumbo v5, " (syncer thread started)"
