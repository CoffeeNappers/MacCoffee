...
.method protected shouldExtract(Ljava/util/zip/ZipEntry;Ljava/lang/String;)Z
    ...
    .line 60
    const-string/jumbo v7, "ApkSoSource"

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v9, "allowing consideration of "
    ...
    const-string/jumbo v9, ": self-extraction preferred"
    ...
    .line 66
    const-string/jumbo v8, "ApkSoSource"

    const-string/jumbo v9, "allowing considering of %s: %s not in system lib dir"
    ...
    const-string/jumbo v9, "allowing consideration of %s: sysdir file length is %s, but the file is %s bytes long in the APK"
    ...
    .line 90
    :cond_2
    const-string/jumbo v6, "ApkSoSource"

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v9, "not allowing consideration of "
    ...
    const-string/jumbo v9, ": deferring to libdir"
