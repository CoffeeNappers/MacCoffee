.class public Lcom/vkontakte/android/SystemUtils;
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lcom/vkontakte/android/SystemUtils;->isArt()Z
    ...
    :goto_0
    sput-boolean v0, Lcom/vkontakte/android/SystemUtils;->IS_ART_RUNTIME:Z
...
.method public static readSerializerSerializableList(Lcom/vkontakte/android/utils/Serializer;Ljava/util/List;Ljava/lang/Class;)V
    .locals 3
    .param p0, "in"    # Lcom/vkontakte/android/utils/Serializer;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T::",
            "Landroid/os/Parcelable;",
    ...
    invoke-virtual {p0, v2}, Lcom/vkontakte/android/utils/Serializer;->readSerializable(Ljava/lang/ClassLoader;)Lcom/vkontakte/android/utils/Serializer$Serializable;
...
.method public static writeSerializerSerializableList(Lcom/vkontakte/android/utils/Serializer;Ljava/util/List;)V
    .locals 3
    .param p0, "out"    # Lcom/vkontakte/android/utils/Serializer;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/vkontakte/android/utils/Serializer;",
    ...
    .prologue
    .line 49
    .local p1, "list":Ljava/util/List;, "Ljava/util/List<+Lcom/vkontakte/android/utils/Serializer$Serializable;>;"
    invoke-interface {p1}, Ljava/util/List;->size()I
    ...
    check-cast v0, Lcom/vkontakte/android/utils/Serializer$Serializable;

    .line 51
    .local v0, "p":Lcom/vkontakte/android/utils/Serializer$Serializable;
    invoke-virtual {p0, v0}, Lcom/vkontakte/android/utils/Serializer;->writeSerializable(Lcom/vkontakte/android/utils/Serializer$Serializable;)V

    goto :goto_0

    .line 53
    .end local v0    # "p":Lcom/vkontakte/android/utils/Serializer$Serializable;
    :cond_0
    return-void
.end method
