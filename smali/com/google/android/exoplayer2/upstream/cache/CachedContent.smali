...
.method private getSpanInternal(J)Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    .locals 7
    .param p1, "position"    # J
    ...
    invoke-static {v2, p1, p2}, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->createLookup(Ljava/lang/String;J)Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;

    move-result-object v1

    .line 199
    .local v1, "lookupSpan":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    ...
    .line 200
    .local v0, "floorSpan":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    if-eqz v0, :cond_0

    iget-wide v2, v0, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->position:J

    iget-wide v4, v0, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->length:J
    ...
    .end local v0    # "floorSpan":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    :cond_1
    return-object v0
.end method
...
.method public getSpan(J)Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    ...
    .prologue
    .line 109
    invoke-direct {p0, p1, p2}, Lcom/google/android/exoplayer2/upstream/cache/CachedContent;->getSpanInternal(J)Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    ...
    .line 112
    .local v0, "ceilEntry":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    if-nez v0, :cond_0

    iget-object v2, p0, Lcom/google/android/exoplayer2/upstream/cache/CachedContent;->key:Ljava/lang/String;

    invoke-static {v2, p1, p2}, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->createOpenHole(Ljava/lang/String;J)Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;

    move-result-object v2

    .line 115
    .end local v0    # "ceilEntry":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    :goto_0
    return-object v2

    .line 112
    .restart local v0    # "ceilEntry":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    :cond_0
    iget-object v2, p0, Lcom/google/android/exoplayer2/upstream/cache/CachedContent;->key:Ljava/lang/String;
    ...
    .line 113
    invoke-static {v2, p1, p2, v4, v5}, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->createClosedHole(Ljava/lang/String;JJ)Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
...
.method public isCached(JJ)Z
    ...
    .line 121
    .local v2, "floorSpan":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    iget-boolean v6, v2, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->isCached:Z
    ...
    iget-wide v6, v2, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->position:J

    iget-wide v8, v2, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->length:J
    ...
    .line 132
    .local v3, "next":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    iget-wide v8, v3, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->position:J
    ...
    iget-wide v10, v3, Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;->length:J
    ...
    .line 145
    .end local v3    # "next":Lcom/google/android/exoplayer2/upstream/cache/SimpleCacheSpan;
    :cond_4
    const/4 v6, 0x0
