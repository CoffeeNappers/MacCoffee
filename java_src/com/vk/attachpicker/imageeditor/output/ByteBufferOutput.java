...
public class ByteBufferOutput extends GLRenderer implements GLTextureInputRenderer {
    ...
    /* loaded from: classes2.dex */
    public interface ByteBufferOutputCallback {
        void bufferCreated(ByteBuffer byteBuffer);
    }

    public ByteBufferOutput(int outputWidth, int outputHeight, ByteBufferOutputCallback callback) {
    ...
    public void drawFrame() {
        ...
        super.drawFrame();
        ByteBuffer hsvBuffer = ByteBuffer.allocateDirect(getWidth() * getHeight() * 4);
        GLES20.glReadPixels(0, 0, getWidth(), getHeight(), 6408, 5121, hsvBuffer);
        this.callback.bufferCreated(hsvBuffer);
    }
