...
final /* synthetic */ class ViewerToolbar$$Lambda$4 implements NotificationListener {
    private final ViewerToolbar arg$1;

    private ViewerToolbar$$Lambda$4(ViewerToolbar viewerToolbar) {
        this.arg$1 = viewerToolbar;
    }

    public static NotificationListener lambdaFactory$(ViewerToolbar viewerToolbar) {
        return new ViewerToolbar$$Lambda$4(viewerToolbar);
    }
