...
public final /* synthetic */ class StoryViewContainer$$Lambda$1 implements NotificationListener {
    private final StoryViewContainer arg$1;

    private StoryViewContainer$$Lambda$1(StoryViewContainer storyViewContainer) {
        this.arg$1 = storyViewContainer;
    }

    public static NotificationListener lambdaFactory$(StoryViewContainer storyViewContainer) {
        return new StoryViewContainer$$Lambda$1(storyViewContainer);
    }

    @Override // com.vk.attachpicker.events.NotificationListener
    @LambdaForm.Hidden
    public void onNotification(int i, int i2, Object obj) {
        this.arg$1.lambda$new$0(i, i2, (StoriesController.StoryUpload) obj);
    }
}
