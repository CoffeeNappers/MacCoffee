...
public final class StoriesGestureDetectorCompat {
    ...
    static class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
        ...
        @Override // com.vk.stories.view.StoriesGestureDetectorCompat.GestureDetectorCompatImpl
            ...
            switch (action & 255) {
                case 0:
                    ...
                    if (this.mIsLongpressEnabled) {
                        ...
                        this.mHandler.sendEmptyMessageAtTime(2, this.mCurrentDownEvent.getDownTime() + TAP_TIMEOUT + 200);
                    }
    ...
    public StoriesGestureDetectorCompat(Context context, GestureDetector.OnGestureListener listener) {
        this(context, listener, null);
    }

    public StoriesGestureDetectorCompat(Context context, GestureDetector.OnGestureListener listener, Handler handler) {
