...
final /* synthetic */ class MusicModelImpl$$Lambda$3 implements Subscriber {
    private final MusicModelImpl arg$1;

    private MusicModelImpl$$Lambda$3(MusicModelImpl musicModelImpl) {
        this.arg$1 = musicModelImpl;
    }

    public static Subscriber lambdaFactory$(MusicModelImpl musicModelImpl) {
        return new MusicModelImpl$$Lambda$3(musicModelImpl);
    }
