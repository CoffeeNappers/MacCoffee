...
final /* synthetic */ class MusicModelCatalogBlock$2$$Lambda$4 implements ObservableModel.Notification {
    private final MusicModelCatalogBlock.AnonymousClass2 arg$1;
    private final VKAPIRequest.VKErrorResponse arg$2;

    private MusicModelCatalogBlock$2$$Lambda$4(MusicModelCatalogBlock.AnonymousClass2 anonymousClass2, VKAPIRequest.VKErrorResponse vKErrorResponse) {
    ...
    public static ObservableModel.Notification lambdaFactory$(MusicModelCatalogBlock.AnonymousClass2 anonymousClass2, VKAPIRequest.VKErrorResponse vKErrorResponse) {
        return new MusicModelCatalogBlock$2$$Lambda$4(anonymousClass2, vKErrorResponse);
    }

    @Override // com.vk.music.model.ObservableModel.Notification
    @LambdaForm.Hidden
    public void accept(Object obj) {
        this.arg$1.lambda$fail$3(this.arg$2, (MusicModel.Callback) obj);
    }
}
