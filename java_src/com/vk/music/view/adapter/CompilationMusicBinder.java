...
public class CompilationMusicBinder implements ItemViewHolder.Binder<MusicTrack> {
    ...
    public CompilationMusicBinder(@NonNull PlayerModel model) {
        this.model = model;
    }
    ...
    public ViewRefs onCreate(@NonNull View itemView) {
        ...
        return new ViewRefs().put(playingIndicator).put(itemView.findViewById(R.id.audio_number)).put(itemView.findViewById(R.id.audio_title)).put(itemView.findViewById(R.id.audio_artist)).put(itemView.findViewById(R.id.audio_duration));
    }
