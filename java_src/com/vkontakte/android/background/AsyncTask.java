...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() { // from class: com.vkontakte.android.background.AsyncTask.1
    ...
    public AsyncTask<Params, Progress, Result> execPool(final Params... params) {
        ...
        sPool.execute(new Runnable() { // from class: com.vkontakte.android.background.AsyncTask.2
