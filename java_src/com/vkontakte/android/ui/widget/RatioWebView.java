...
public class RatioWebView extends WebView {
    ...
    public RatioWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.orientation = 1;
        this.imageRatio = 0.0f;
        init(attrs);
    ...
    public RatioWebView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public RatioWebView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setRatio(float imageRatio) {
