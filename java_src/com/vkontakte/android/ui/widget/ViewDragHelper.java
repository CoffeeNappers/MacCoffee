...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new Interpolator() { // from class: com.vkontakte.android.ui.widget.ViewDragHelper.1
    ...
    private final Runnable mSetIdleRunnable = new Runnable() { // from class: com.vkontakte.android.ui.widget.ViewDragHelper.2
            ...
            case 2:
                ...
                for (int i = 0; i < pointerCount && this.mInitialMotionX != null && this.mInitialMotionY != null; i++) {
                    ...
                    if (pointerId2 < this.mInitialMotionX.length && pointerId2 < this.mInitialMotionY.length) {
                        ...
                        if (this.mDragState != 1) {
                            View toCapture3 = findTopChildUnder((int) this.mInitialMotionX[pointerId2], (int) this.mInitialMotionY[pointerId2]);
                            if (toCapture3 != null && checkTouchSlop(toCapture3, dx, dy) && tryCaptureViewForDrag(toCapture3, pointerId2)) {
                            }
                        }
                    }
                }
