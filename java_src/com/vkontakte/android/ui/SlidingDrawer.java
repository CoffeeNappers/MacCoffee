...
public class SlidingDrawer extends ViewGroup {
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        if (!this.mTracking && !frame.contains((int) x, (int) y) && (frame.right > 0 || x > getWidth() / 2 || y < Global.scale(160.0f) || y > getHeight() - Global.scale(120.0f))) {
            return false;
        }
        if (action == 0) {
            this.mTracking = true;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:48:0x00ac, code lost:
        if (r14.mAllowSingleTap == false) goto L47;
     */
    /* JADX WARN: Code restructure failed: missing block: B:50:0x00b2, code lost:
        if (isOpened() != false) goto L47;
     */
    /* JADX WARN: Code restructure failed: missing block: B:51:0x00b4, code lost:
        playSoundEffect(0);
     */
    /* JADX WARN: Code restructure failed: missing block: B:52:0x00ba, code lost:
        if (r14.mExpanded == false) goto L44;
     */
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.vkontakte.android.ui.SlidingDrawer.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    */
    private void performFling(int r7, float r8, boolean r9) {
        ...
        L95:
            ...
            goto L33
        */
        throw new UnsupportedOperationException("Method not decompiled: com.vkontakte.android.ui.SlidingDrawer.performFling(int, float, boolean):void");
    }
