...
final /* synthetic */ class HeaderPostDisplayItem$SubscribeClickListener$$Lambda$1 implements F0 {
    private final HeaderPostDisplayItem.SubscribeClickListener arg$1;

    private HeaderPostDisplayItem$SubscribeClickListener$$Lambda$1(HeaderPostDisplayItem.SubscribeClickListener subscribeClickListener) {
    ...
    public static F0 lambdaFactory$(HeaderPostDisplayItem.SubscribeClickListener subscribeClickListener) {
        return new HeaderPostDisplayItem$SubscribeClickListener$$Lambda$1(subscribeClickListener);
    }
