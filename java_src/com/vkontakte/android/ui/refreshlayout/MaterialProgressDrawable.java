...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private final Drawable.Callback mCallback = new Drawable.Callback() { // from class: com.vkontakte.android.ui.refreshlayout.MaterialProgressDrawable.3
    ...
    private void setupAnimators() {
        ...
        Animation animation = new Animation() { // from class: com.vkontakte.android.ui.refreshlayout.MaterialProgressDrawable.1
        ...
        animation.setAnimationListener(new Animation.AnimationListener() { // from class: com.vkontakte.android.ui.refreshlayout.MaterialProgressDrawable.2
