...
public class RecentItemStore {
    ...
    public String[] update() {
        ...
        if (this.countUses) {
            ...
            Collections.sort(r, new Comparator<RecentItem>() { // from class: com.vkontakte.android.data.RecentItemStore.1
    ...
    private void save() {
        ...
        edit.putString(str, TextUtils.join(",", sdata)).commit();
    }
