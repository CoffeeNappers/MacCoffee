...
public class ContainerFragment extends VKFragment {
    ...
    private class InnerFragmentTransaction extends FragmentTransaction {
        ...
        public int commit() {
            if (!ContainerFragment.this.activityCreated) {
                ContainerFragment.this.runQueue.add(new Runnable() { // from class: com.vkontakte.android.fragments.ContainerFragment.InnerFragmentTransaction.1
        ...
        public int commitAllowingStateLoss() {
            if (!ContainerFragment.this.activityCreated) {
                ContainerFragment.this.runQueue.add(new Runnable() { // from class: com.vkontakte.android.fragments.ContainerFragment.InnerFragmentTransaction.2
                    @Override // java.lang.Runnable
                    public void run() {
