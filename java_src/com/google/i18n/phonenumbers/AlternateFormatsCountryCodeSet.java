...
public class AlternateFormatsCountryCodeSet {
    ...
    public static Set<Integer> getCountryCodeSet() {
        ...
        countryCodeSet.add(Integer.valueOf((int) GCMBroadcastReceiver.ID_GAME_INSTALL_NOTIFICATION));
        countryCodeSet.add(Integer.valueOf((int) GCMBroadcastReceiver.ID_GIFT_NOTIFICATION));
