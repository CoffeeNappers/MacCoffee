...
public interface zzv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzv {
        ...
        /* loaded from: classes2.dex */
        private static class C0189zza implements zzv {
        ...
        public static zzv zzio(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMarkerDragListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzv)) ? new C0189zza(iBinder) : (zzv) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zzb(zzf.zza.zzjk(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IOnMarkerDragListener");
                    zzd(zzf.zza.zzjk(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 3:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IOnMarkerDragListener");
                    zzc(zzf.zza.zzjk(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
