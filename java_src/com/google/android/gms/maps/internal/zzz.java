...
public interface zzz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzz {
        ...
        /* loaded from: classes2.dex */
        private static class C0193zza implements zzz {
        ...
        public static zzz zzis(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzz)) ? new C0193zza(iBinder) : (zzz) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(zzg.zza.zzjl(parcel.readStrongBinder()));
