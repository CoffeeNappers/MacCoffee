...
public interface zzy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzy {
        ...
        /* loaded from: classes2.dex */
        private static class C0192zza implements zzy {
        ...
        public static zzy zzir(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnPoiClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzy)) ? new C0192zza(iBinder) : (zzy) queryLocalInterface;
        }
