...
public interface zzag extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzag {
        ...
        /* loaded from: classes2.dex */
        private static class C0168zza implements zzag {
        ...
        public static zzag zzja(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzag)) ? new C0168zza(iBinder) : (zzag) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 2:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.ISnapshotReadyCallback");
                    zzag(zzd.zza.zzfd(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
    ...
    void zzag(com.google.android.gms.dynamic.zzd zzdVar) throws RemoteException;
}
