...
public interface zzab extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzab {
        ...
        /* loaded from: classes2.dex */
        private static class C0163zza implements zzab {
        ...
        public static zzab zziu(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzab)) ? new C0163zza(iBinder) : (zzab) queryLocalInterface;
        }
