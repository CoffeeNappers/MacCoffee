...
public interface IMapViewDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IMapViewDelegate {
        ...
        /* loaded from: classes2.dex */
        private static class C0156zza implements IMapViewDelegate {
        ...
        public static IMapViewDelegate zzhw(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IMapViewDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMapViewDelegate)) ? new C0156zza(iBinder) : (IMapViewDelegate) queryLocalInterface;
        }
