...
public interface zzaf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaf {
        ...
        /* loaded from: classes2.dex */
        private static class C0167zza implements zzaf {
        ...
        public static zzaf zziy(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaf)) ? new C0167zza(iBinder) : (zzaf) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(IStreetViewPanoramaDelegate.zza.zzjb(parcel.readStrongBinder()));
