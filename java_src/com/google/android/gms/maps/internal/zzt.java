...
public interface zzt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzt {
        ...
        /* loaded from: classes2.dex */
        public static class C0187zza implements zzt {
        ...
        public static zzt zzim(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzt)) ? new C0187zza(iBinder) : (zzt) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(IGoogleMapDelegate.zza.zzhs(parcel.readStrongBinder()));
