...
public interface IPolylineDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IPolylineDelegate {
        ...
        /* loaded from: classes2.dex */
        public static class C0194zza implements IPolylineDelegate {
        ...
        public static IPolylineDelegate zzjm(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IPolylineDelegate)) ? new C0194zza(iBinder) : (IPolylineDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 15:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    boolean equalsRemote = equalsRemote(zzjm(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    if (equalsRemote) {
                        i6 = 1;
                    }
