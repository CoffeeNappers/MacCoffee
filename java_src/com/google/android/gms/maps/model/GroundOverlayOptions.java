...
public final class GroundOverlayOptions extends AbstractSafeParcelable {
    ...
    public GroundOverlayOptions(int i, IBinder iBinder, LatLng latLng, float f, float f2, LatLngBounds latLngBounds, float f3, float f4, boolean z, float f5, float f6, float f7, boolean z2) {
        ...
        this.apL = false;
        this.mVersionCode = i;
        this.apN = new BitmapDescriptor(zzd.zza.zzfd(iBinder));
        this.apO = latLng;
        this.apP = f;
        this.apQ = f2;
    ...
    public GroundOverlayOptions position(LatLng latLng, float f) {
        boolean z = true;
        zzaa.zza(this.anI == null, "Position has already been set using positionFromBounds");
        zzaa.zzb(latLng != null, "Location must be specified");
        if (f < 0.0f) {
            z = false;
        }
        zzaa.zzb(z, "Width must be non-negative");
    ...
    public GroundOverlayOptions position(LatLng latLng, float f, float f2) {
        ...
        zzaa.zzb(z, "Height must be non-negative");
