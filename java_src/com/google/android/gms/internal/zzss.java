...
public interface zzss extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzss {
        ...
        /* loaded from: classes2.dex */
        private static class C0131zza implements zzss {
        ...
        public static zzss zzea(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzss)) ? new C0131zza(iBinder) : (zzss) queryLocalInterface;
        }
