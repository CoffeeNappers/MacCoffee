...
public interface zzxk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzxk {
        ...
        /* loaded from: classes2.dex */
        private static class C0143zza implements zzxk {
        ...
        public static zzxk zzks(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzxk)) ? new C0143zza(iBinder) : (zzxk) queryLocalInterface;
        }
