...
public interface zzeo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzeo {
        ...
        /* loaded from: classes2.dex */
        private static class C0089zza implements zzeo {
        ...
        public static zzeo zzag(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzeo)) ? new C0089zza(iBinder) : (zzeo) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    String zzba = zzba(parcel.readString());
