...
public interface zzck extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzck {
        ...
        /* loaded from: classes2.dex */
        private static class C0080zza implements zzck {
        ...
        public static zzck zze(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzck)) ? new C0080zza(iBinder) : (zzck) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    IBinder zza = zza(parcel.readString(), zzd.zza.zzfd(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    parcel2.writeStrongBinder(zza);
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.ads.adshield.internal.IAdShieldCreator");
                    IBinder zzb = zzb(parcel.readString(), zzd.zza.zzfd(parcel.readStrongBinder()));
                    parcel2.writeNoException();
