...
public interface zzvt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzvt {
        ...
        /* loaded from: classes2.dex */
        private static class C0137zza implements zzvt {
        ...
        public static zzvt asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzvt)) ? new C0137zza(iBinder) : (zzvt) queryLocalInterface;
        }
