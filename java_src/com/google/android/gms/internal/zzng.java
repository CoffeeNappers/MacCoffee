...
public interface zzng extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzng {
        ...
        /* loaded from: classes2.dex */
        private static class C0120zza implements zzng {
        ...
        public static zzng zzbo(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzng)) ? new C0120zza(iBinder) : (zzng) queryLocalInterface;
        }
