...
public interface zzif extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzif {
        ...
        /* renamed from: com.google.android.gms.internal.zzif$zza$zza  reason: collision with other inner class name */
        /* loaded from: classes2.dex */
        private static class C0110zza implements zzif {
        ...
        public static zzif zzaw(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzif)) ? new C0110zza(iBinder) : (zzif) queryLocalInterface;
        }
