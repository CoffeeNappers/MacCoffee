...
public interface zzem extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzem {
        ...
        /* loaded from: classes2.dex */
        private static class C0088zza implements zzem {
        ...
        public static zzem zzaf(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzem)) ? new C0088zza(iBinder) : (zzem) queryLocalInterface;
        }
