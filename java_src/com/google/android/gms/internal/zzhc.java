...
public interface zzhc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhc {
        ...
        /* loaded from: classes2.dex */
        private static class C0104zza implements zzhc {
        ...
        public static zzhc zzap(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhc)) ? new C0104zza(iBinder) : (zzhc) queryLocalInterface;
        }
