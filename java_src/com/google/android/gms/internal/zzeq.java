...
public interface zzeq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzeq {
        ...
        /* loaded from: classes2.dex */
        private static class C0090zza implements zzeq {
        ...
        public static zzeq zzah(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzeq)) ? new C0090zza(iBinder) : (zzeq) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(zzek.zza.zzae(parcel.readStrongBinder()));
