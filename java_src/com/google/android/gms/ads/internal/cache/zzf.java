...
public interface zzf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzf {
        ...
        /* loaded from: classes.dex */
        private static class C0004zza implements zzf {
            ...
            @Override // com.google.android.gms.ads.internal.cache.zzf
            public CacheEntryParcel zza(CacheOffering cacheOffering) throws RemoteException {
                ...
                try {
                    ...
                    return obtain2.readInt() != 0 ? CacheEntryParcel.CREATOR.createFromParcel(obtain2) : null;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
        ...
        public static zzf zzi(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzf)) ? new C0004zza(iBinder) : (zzf) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    CacheEntryParcel zza = zza(parcel.readInt() != 0 ? CacheOffering.CREATOR.createFromParcel(parcel) : null);
