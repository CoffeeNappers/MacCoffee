...
public final class HlsSampleStreamWrapper implements Loader.Callback<Chunk>, SequenceableLoader, ExtractorOutput, DefaultTrackOutput.UpstreamFormatChangedListener {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean isReady(int group) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public int readData(int group, FormatHolder formatHolder, DecoderInputBuffer buffer) {
        if (isPendingReset()) {
            return -3;
        }
        ...
        return this.sampleQueues.valueAt(group).readData(formatHolder, buffer, this.loadingFinished, this.lastSeekPositionUs);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void skipToKeyframeBefore(int group, long timeUs) {
        this.sampleQueues.valueAt(group).skipToKeyframeBefore(timeUs);
    }
    ...
    /* renamed from: track */
    public DefaultTrackOutput mo366track(int id) {
