    ...
    private void readHeaderRemainder(ParsableByteArray source) {
        ...
        if (this.frameBytesRead >= 4) {
            ...
            if (!this.hasOutputFormat) {
                ...
                Format format = Format.createAudioSampleFormat(null, this.header.mimeType, null, -1, 4096, this.header.channels, this.header.sampleRate, null, null, 0, this.language);
