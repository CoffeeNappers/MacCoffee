...
final class AdtsReader implements ElementaryStreamReader {
    ...
    public void createTracks(ExtractorOutput extractorOutput, TsPayloadReader.TrackIdGenerator idGenerator) {
        ...
        if (this.exposeId3) {
            this.id3Output = extractorOutput.mo366track(idGenerator.getNextId());
        ...
        while (position2 < endOffset) {
            ...
            switch (this.matchState | data) {
                case 329:
                    ...
                    break;
                case GCMBroadcastReceiver.ID_FRIEND_ACCEPTED_NOTIFICATION /* 511 */:
                    this.matchState = 512;
                    break;
                case 836:
    ...
    private void parseAdtsHeader() {
        ...
        if (!this.hasOutputFormat) {
            ...
            Format format = Format.createAudioSampleFormat(null, "audio/mp4a-latm", null, -1, -1, ((Integer) audioParams.second).intValue(), ((Integer) audioParams.first).intValue(), Collections.singletonList(audioSpecificConfig), null, 0, this.language);
