...
public interface INowAuthService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INowAuthService {
        ...
        public static INowAuthService asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin != null && (iin instanceof INowAuthService)) {
                return (INowAuthService) iin;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 2:
                    ...
                    Bundle _result = getAuthCode(_arg0, _arg1);
        ...
        private static class Proxy implements INowAuthService {
            ...
            @Override // com.google.android.now.INowAuthService
            public Bundle getAuthCode(String clientId, String packageName) throws RemoteException {
                Bundle _result;
