...
public final class YouTubeStandalonePlayer {
    ...
    public static Intent createPlaylistIntent(Activity activity, String str, String str2, int i, int i2, boolean z, boolean z2) {
        ...
        if (str != null) {
            return a(new Intent("com.google.android.youtube.api.StandalonePlayerActivity.START").putExtra(AudioContentProviderConstants.MUSIC_TRACK_COLUMN_PLAY_LIST_ID, str2).putExtra("current_index", i), activity, str, i2, z, z2);
        }
