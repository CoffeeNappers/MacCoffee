...
public final class x {
    public static Map<String, String> a(Locale locale) {
        ...
        a(hashMap, new StringBuilder(String.valueOf(valueOf).length() + 1 + String.valueOf(valueOf2).length()).append(valueOf).append(EventsFilesManager.ROLL_OVER_FILE_NAME_SEPARATOR).append(valueOf2).toString());
        return hashMap;
    }
