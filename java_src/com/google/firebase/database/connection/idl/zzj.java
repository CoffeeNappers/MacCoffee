...
public interface zzj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzj {
        ...
        /* loaded from: classes2.dex */
        private static class C0231zza implements zzj {
        ...
        public static zzj zzmi(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzj)) ? new C0231zza(iBinder) : (zzj) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zzbn(parcel.readString(), parcel.readString());
    ...
    void zzbn(String str, String str2) throws RemoteException;
}
