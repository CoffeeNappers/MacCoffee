...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{385}, "HR");
            add(new int[]{387}, "BA");
            add(new int[]{SearchViewWrapper.CONFIRM_TIMEOUT, 440}, "DE");
            ...
            add(new int[]{478}, "UZ");
            add(new int[]{479}, "LK");
            add(new int[]{CameraUtils.Settings.LOW_HEIGHT}, "PH");
            add(new int[]{481}, "BY");
            add(new int[]{482}, "UA");
            add(new int[]{484}, "MD");
            add(new int[]{485}, "AM");
            ...
            add(new int[]{500, GCMBroadcastReceiver.ID_REPOST_NOTIFICATION}, "GB");
            add(new int[]{GCMBroadcastReceiver.ID_OPEN_URL_NOTIFICATION_FIRST}, "GR");
            add(new int[]{528}, ExpandedProductParsedResult.POUND);
            add(new int[]{529}, "CY");
            add(new int[]{531}, "MK");
            add(new int[]{535}, "MT");
            add(new int[]{539}, "IE");
            add(new int[]{GCMBroadcastReceiver.ID_VALIDATE_DEVICE_NOTIFICATION_FIRST, 549}, "BE/LU");
            add(new int[]{GCMBroadcastReceiver.ID_VALIDATE_ACTION_NOTIFICATION_FIRST}, "PT");
            add(new int[]{569}, "IS");
            ...
            add(new int[]{628}, "SA");
            add(new int[]{629}, "AE");
            add(new int[]{CameraUtils.Settings.LOW_WIDTH, 649}, "FI");
            ...
            add(new int[]{VKAPIRequest.ERROR_VIDEO_ALREADY_ADDED, 839}, "IT");
