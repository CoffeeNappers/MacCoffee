...
public class H265TrackImplOld {
    ...
    public NalUnitHeader getNalUnitHeader(ByteBuffer nal) {
        ...
        nalUnitHeader.nuhLayerId = (nal_unit_header & GCMBroadcastReceiver.ID_GAME_NOTIFICATION) >> 3;
    ...
    public class LookAhead {
        ...
        public void fillBuffer() throws IOException {
            this.buffer = this.dataSource.map(this.bufferStartPos, Math.min(this.dataSource.size() - this.bufferStartPos, (long) H265TrackImplOld.BUFFER));
        }
