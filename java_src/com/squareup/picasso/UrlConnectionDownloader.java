...
public class UrlConnectionDownloader implements Downloader {
    ...
    public Downloader.Response load(Uri uri, int networkPolicy) throws IOException {
        ...
        if (responseCode >= 300) {
            ...
            throw new Downloader.ResponseException(responseCode + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + connection.getResponseMessage(), networkPolicy, responseCode);
        }
