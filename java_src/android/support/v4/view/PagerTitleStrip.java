...
public class PagerTitleStrip extends ViewGroup {
    ...
    protected void onAttachedToWindow() {
        ...
        PagerAdapter adapter = pager.mo1110getAdapter();
    ...
    protected void onDetachedFromWindow() {
        ...
        if (this.mPager != null) {
            updateAdapter(this.mPager.mo1110getAdapter(), null);
    ...
    public void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        if (position != this.mLastKnownCurrentPage) {
            updateText(position, this.mPager.mo1110getAdapter());
    ...
    public class PageListener extends DataSetObserver implements ViewPager.OnPageChangeListener, ViewPager.OnAdapterChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            if (this.mScrollState == 0) {
                PagerTitleStrip.this.updateText(PagerTitleStrip.this.mPager.getCurrentItem(), PagerTitleStrip.this.mPager.mo1110getAdapter());
