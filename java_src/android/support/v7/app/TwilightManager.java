...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        calculator.calculateTwilight(now - TimeUtils.DAY, location.getLatitude(), location.getLongitude());
        ...
        calculator.calculateTwilight(TimeUtils.DAY + now, location.getLatitude(), location.getLongitude());
