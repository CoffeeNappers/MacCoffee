...
public class Toolbar extends ViewGroup {
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            LayoutParams lp = mo154generateDefaultLayoutParams();
    ...
    private void addSystemView(View v, boolean allowHide) {
        ...
        if (vlp == null) {
            lp = mo154generateDefaultLayoutParams();
        } else if (!checkLayoutParams(vlp)) {
            lp = mo156generateLayoutParams(vlp);
        } else {
            lp = (LayoutParams) vlp;
        }
        lp.mViewType = 1;
    ...
    public LayoutParams mo155generateLayoutParams(AttributeSet attrs) {
    ...
    @Override // android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo156generateLayoutParams(ViewGroup.LayoutParams p) {
    ...
    public LayoutParams mo154generateDefaultLayoutParams() {
    ...
    public class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (Toolbar.this.mExpandedActionView.getParent() != Toolbar.this) {
                LayoutParams lp = Toolbar.this.mo154generateDefaultLayoutParams();
