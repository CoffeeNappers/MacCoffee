...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    public LayoutParams mo139generateDefaultLayoutParams() {
    ...
    public LayoutParams mo140generateLayoutParams(AttributeSet attrs) {
    ...
    @Override // android.support.v7.widget.LinearLayoutCompat, android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo141generateLayoutParams(ViewGroup.LayoutParams p) {
        if (p != null) {
        ...
        return mo139generateDefaultLayoutParams();
    }
    ...
    public LayoutParams generateOverflowButtonLayoutParams() {
        LayoutParams result = mo139generateDefaultLayoutParams();
