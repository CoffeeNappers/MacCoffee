...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getDrawableFromResourceValue(String drawableId) {
        ...
        try {
            ...
            String drawableUri = "android.resource://" + this.mProviderContext.getPackageName() + CameraUtilsEffects.FILE_DELIM + resourceId;
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchable, String query, int limit) {
        ...
        if (limit > 0) {
            uriBuilder.appendQueryParameter(ArgKeys.LIMIT, String.valueOf(limit));
        }
