    ...
    public void applyToInternal(ConstraintLayout constraintLayout) {
        ...
        while (it.hasNext()) {
            ...
            if (constraint2.mIsGuideline) {
                ...
                ConstraintLayout.LayoutParams param2 = constraintLayout.mo0generateDefaultLayoutParams();
    ...
    */
    public void load(android.content.Context r11, int r12) {
        /*
            ...
            r1 = 0
            r6 = 0
            int r3 = r4.getEventType()     // Catch: org.xmlpull.v1.XmlPullParserException -> L42 java.io.IOException -> L49
        Lf:
            if (r3 == r9) goto L46
            switch(r3) {
                case 0: goto L19;
                ...
                case 3: goto L47;
                default: goto L14;
            }     // Catch: org.xmlpull.v1.XmlPullParserException -> L42 java.io.IOException -> L49
        L14:
            int r3 = r4.next()     // Catch: org.xmlpull.v1.XmlPullParserException -> L42 java.io.IOException -> L49
            goto Lf
        L19:
            java.lang.String r1 = r4.getName()     // Catch: org.xmlpull.v1.XmlPullParserException -> L42 java.io.IOException -> L49
            goto L14
        L1e:
            java.lang.String r6 = r4.getName()     // Catch: org.xmlpull.v1.XmlPullParserException -> L42 java.io.IOException -> L49
            android.util.AttributeSet r7 = android.util.Xml.asAttributeSet(r4)     // Catch: org.xmlpull.v1.XmlPullParserException -> L42 java.io.IOException -> L49
            android.support.constraint.ConstraintSet$Constraint r0 = r10.fillFromAttributeList(r11, r7)     // Catch: org.xmlpull.v1.XmlPullParserException -> L42 java.io.IOException -> L49
            java.lang.String r7 = "Guideline"
            boolean r7 = r6.equalsIgnoreCase(r7)     // Catch: org.xmlpull.v1.XmlPullParserException -> L42 java.io.IOException -> L49
            if (r7 == 0) goto L36
            r7 = 1
            r0.mIsGuideline = r7     // Catch: org.xmlpull.v1.XmlPullParserException -> L42 java.io.IOException -> L49
        L36:
            java.util.HashMap<java.lang.Integer, android.support.constraint.ConstraintSet$Constraint> r7 = r10.mConstraints     // Catch: org.xmlpull.v1.XmlPullParserException -> L42 java.io.IOException -> L49
            int r8 = r0.mViewId     // Catch: org.xmlpull.v1.XmlPullParserException -> L42 java.io.IOException -> L49
            java.lang.Integer r8 = java.lang.Integer.valueOf(r8)     // Catch: org.xmlpull.v1.XmlPullParserException -> L42 java.io.IOException -> L49
            r7.put(r8, r0)     // Catch: org.xmlpull.v1.XmlPullParserException -> L42 java.io.IOException -> L49
            goto L14
        L42:
            r2 = move-exception
            r2.printStackTrace()
