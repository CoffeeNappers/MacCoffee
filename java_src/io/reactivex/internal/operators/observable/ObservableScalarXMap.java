...
public final class ObservableScalarXMap {
    ...
    public static <T, R> boolean tryScalarXMapSubscribe(ObservableSource<T> source, Observer<? super R> observer, Function<? super T, ? extends ObservableSource<? extends R>> mapper) {
        if (source instanceof Callable) {
            try {
                ...
                try {
                    ObservableSource<? extends R> r = (ObservableSource) ObjectHelper.requireNonNull(mapper.mo1190apply(obj), "The mapper returned a null ObservableSource");
    ...
    public static final class ScalarXMapObservable<T, R> extends Observable<R> {
        ...
        public void subscribeActual(Observer<? super R> s) {
            try {
                ObservableSource<? extends R> other = (ObservableSource) ObjectHelper.requireNonNull(this.mapper.mo1190apply((T) this.value), "The mapper returned a null ObservableSource");
                if (other instanceof Callable) {
                    try {
                        ...
                        ScalarDisposable<R> sd = new ScalarDisposable<>(s, call);
                        s.onSubscribe(sd);
                        sd.run();
                        return;
                    } catch (Throwable ex) {
