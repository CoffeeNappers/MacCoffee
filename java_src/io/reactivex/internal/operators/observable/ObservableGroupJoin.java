                ...
                while (!this.cancelled) {
                    ...
                    if (d && empty) {
                        ...
                        if (mode == LEFT_VALUE) {
                            ...
                            try {
                                ObservableSource<TLeftEnd> p = (ObservableSource) ObjectHelper.requireNonNull(this.leftEnd.mo1190apply(val), "The leftEnd returned a null ObservableSource");
                                ...
                                try {
                                    a.onNext((Object) ObjectHelper.requireNonNull(this.resultSelector.apply(val, up), "The resultSelector returned a null value"));
                            ...
                            try {
                                ObservableSource<TRightEnd> p2 = (ObservableSource) ObjectHelper.requireNonNull(this.rightEnd.mo1190apply(val), "The rightEnd returned a null ObservableSource");
