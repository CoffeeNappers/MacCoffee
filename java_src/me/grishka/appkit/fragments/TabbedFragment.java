...
public class TabbedFragment extends ToolbarFragment implements TabbedScreen {
    private TabbedScreen.Delegate delegate = new TabbedScreen.Delegate(this) { // from class: me.grishka.appkit.fragments.TabbedFragment.1
        @Override // me.grishka.appkit.fragments.TabbedScreen.Delegate
        public void onPageSelected(int pos) {
            TabbedFragment.this.onPageSelected(pos);
        }
