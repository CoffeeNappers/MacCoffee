...
public final class Cache implements Closeable, Flushable {
    ...
    public static final class Entry {
        ...
        public void writeTo(DiskLruCache.Editor editor) throws IOException {
            ...
            sink.mo1226writeUtf8(this.url).mo1215writeByte(10);
            sink.mo1226writeUtf8(this.requestMethod).mo1215writeByte(10);
            sink.mo1216writeDecimalLong(this.varyHeaders.size()).mo1215writeByte(10);
            int size = this.varyHeaders.size();
            for (int i = 0; i < size; i++) {
                sink.mo1226writeUtf8(this.varyHeaders.name(i)).mo1226writeUtf8(": ").mo1226writeUtf8(this.varyHeaders.value(i)).mo1215writeByte(10);
            }
            sink.mo1226writeUtf8(new StatusLine(this.protocol, this.code, this.message).toString()).mo1215writeByte(10);
            sink.mo1216writeDecimalLong(this.responseHeaders.size() + 2).mo1215writeByte(10);
            int size2 = this.responseHeaders.size();
            for (int i2 = 0; i2 < size2; i2++) {
                sink.mo1226writeUtf8(this.responseHeaders.name(i2)).mo1226writeUtf8(": ").mo1226writeUtf8(this.responseHeaders.value(i2)).mo1215writeByte(10);
            }
            sink.mo1226writeUtf8(SENT_MILLIS).mo1226writeUtf8(": ").mo1216writeDecimalLong(this.sentRequestMillis).mo1215writeByte(10);
            sink.mo1226writeUtf8(RECEIVED_MILLIS).mo1226writeUtf8(": ").mo1216writeDecimalLong(this.receivedResponseMillis).mo1215writeByte(10);
            if (isHttps()) {
                sink.mo1215writeByte(10);
                sink.mo1226writeUtf8(this.handshake.cipherSuite().javaName()).mo1215writeByte(10);
                ...
                if (this.handshake.tlsVersion() != null) {
                    sink.mo1226writeUtf8(this.handshake.tlsVersion().javaName()).mo1215writeByte(10);
                }
            }
            sink.close();
        }
        ...
        private List<Certificate> readCertificateList(BufferedSource source) throws IOException {
            ...
            try {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    bytes.mo1212write(ByteString.decodeBase64(line));
        ...
        private void writeCertList(BufferedSink sink, List<Certificate> certificates) throws IOException {
            try {
                sink.mo1216writeDecimalLong(certificates.size()).mo1215writeByte(10);
                int size = certificates.size();
                for (int i = 0; i < size; i++) {
                    byte[] bytes = certificates.get(i).getEncoded();
                    String line = ByteString.of(bytes).base64();
                    sink.mo1226writeUtf8(line).mo1215writeByte(10);
                }
