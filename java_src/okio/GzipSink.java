...
public final class GzipSink implements Sink {
    ...
    private void writeHeader() {
        ...
        buffer.mo1222writeShort(8075);
        buffer.mo1215writeByte(8);
        buffer.mo1215writeByte(0);
        buffer.mo1218writeInt(0);
        buffer.mo1215writeByte(0);
        buffer.mo1215writeByte(0);
    }

    private void writeFooter() throws IOException {
        this.sink.mo1219writeIntLe((int) this.crc.getValue());
        this.sink.mo1219writeIntLe((int) this.deflater.getBytesRead());
    }
